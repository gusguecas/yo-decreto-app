...
const Progreso = {
  ...
  async loadProgresoData() {
    const [metricas, porDecreto, timeline] = await Promise.all([
  ...
  renderProgresoPorDecreto() {
    ...
    return `
      <div class="gradient-card p-8 rounded-xl mb-12">
        <h2 class="text-2xl font-semibold mb-6">Progreso por Decreto</h2>
        ...
        <div class="space-y-6">
          ...
          <div>
            <div class="flex items-center justify-between mb-2">
              ...
              <span class="text-sm text-slate-400">
                ${totales.empresarial?.completadas || 0} / ${totales.empresarial?.total_acciones || 0} tareas
              </span>
            </div>
            <div class="w-full bg-slate-700 rounded-full h-3">
              <div 
                class="h-3 rounded-full progress-bar" 
                style="width: ${totales.empresarial?.progreso || 0}%; background: var(--color-accent-green);"
              ></div>
            </div>
            <div class="text-right text-sm font-semibold text-accent-green mt-1">
          ...
          <div>
            <div class="flex items-center justify-between mb-2">
              ...
              <span class="text-sm text-slate-400">
                ${totales.material?.completadas || 0} / ${totales.material?.total_acciones || 0} tareas
              </span>
            </div>
            <div class="w-full bg-slate-700 rounded-full h-3">
              <div 
                class="h-3 rounded-full progress-bar" 
                style="width: ${totales.material?.progreso || 0}%; background: var(--color-accent-orange);"
              ></div>
            </div>
            <div class="text-right text-sm font-semibold text-accent-orange mt-1">
          ...
          <div>
            <div class="flex items-center justify-between mb-2">
              ...
              <span class="text-sm text-slate-400">
                ${totales.humano?.completadas || 0} / ${totales.humano?.total_acciones || 0} tareas
              </span>
            </div>
            <div class="w-full bg-slate-700 rounded-full h-3">
              <div 
                class="h-3 rounded-full progress-bar" 
                style="width: ${totales.humano?.progreso || 0}%; background: var(--color-accent-blue);"
              ></div>
            </div>
            <div class="text-right text-sm font-semibold text-accent-blue mt-1">
