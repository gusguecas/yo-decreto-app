  ...
  return (
    <html lang="es">
      ...
      <body className="bg-slate-900 text-white font-sans">
        ...
        <script src={`/static/ritual-spec.js?v=${Date.now()}&cb=${Math.random()}&t=${new Date().getTime()}`}></script>
        ...
        <script src={`/static/ai-chat-widget.js?v=${Date.now()}&cb=${Math.random()}&t=${new Date().getTime()}`}></script>
