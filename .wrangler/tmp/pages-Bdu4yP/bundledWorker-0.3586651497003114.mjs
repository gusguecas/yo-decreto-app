...
// ../.wrangler/tmp/bundle-uooHqW/strip-cf-connecting-ip-header.js
...
var er = /* @__PURE__ */ __name((e, a, t) => a in e ? Qt(e, a, { enumerable: true, configurable: true, writable: true, value: t }) : e[a] = t, "er");
var T = /* @__PURE__ */ __name((e, a, t) => er(e, typeof a != "symbol" ? a + "" : a, t), "T");
var fa = /* @__PURE__ */ __name((e, a, t) => a.has(e) || Ha("Cannot " + t), "fa");
var u = /* @__PURE__ */ __name((e, a, t) => (fa(e, a, "read from private field"), t ? t.call(e) : a.get(e)), "u");
var O = /* @__PURE__ */ __name((e, a, t) => a.has(e) ? Ha("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(e) : a.set(e, t), "O");
var S = /* @__PURE__ */ __name((e, a, t, r) => (fa(e, a, "write to private field"), r ? r.call(e, t) : a.set(e, t), t), "S");
var C = /* @__PURE__ */ __name((e, a, t) => (fa(e, a, "access private method"), t), "C");
var Ua = /* @__PURE__ */ __name((e, a, t, r) => ({ set _(s) {
  S(e, a, s, t);
}, get _() {
  return u(e, a, r);
} }), "Ua");
var pt = { Stringify: 1 };
var B = /* @__PURE__ */ __name((e, a) => {
  const t = new String(e);
  return t.isEscaped = true, t.callbacks = a, t;
}, "B");
var ar = /[&<>'"]/;
var Et = /* @__PURE__ */ __name(async (e, a) => {
  let t = "";
  a || (a = []);
...
var mt = /* @__PURE__ */ __name(async (e, a, t, r, s) => {
...
var Ba = /* @__PURE__ */ __name((e) => (e[gt] = true, e), "Ba");
var _t = /* @__PURE__ */ __name((e) => ({ value: a, children: t }) => {
  if (!t)
    return;
...
var Fa = /* @__PURE__ */ __name((e, a, t, r) => ({ buffer: s, context: o }) => {
  if (!s)
    return;
  const n = qa.get(o) || {};
  qa.set(o, n);
...
var Ve = /* @__PURE__ */ __name((e, a, t) => B(new W(e, t, ze(a ?? [])).toString()), "Ve");
var Ye = /* @__PURE__ */ __name((e, a, t, r) => {
  if ("itemProp" in t)
    return Ve(e, a, t);
...
var sr = /* @__PURE__ */ __name(({ children: e, ...a }) => {
  const t = Ia();
  if (t) {
    const r = Ae(t);
    if (r === "svg" || r === "head")
...
var or = /* @__PURE__ */ __name(({ children: e, ...a }) => {
  const t = Ia();
  return ["src", "async"].some((r) => !a[r]) || t && Ae(t) === "head" ? Ve("script", e, a) : Ye("script", e, a, false);
}, "or");
var nr = /* @__PURE__ */ __name(({ children: e, ...a }) => ["href", "precedence"].every((t) => t in a) ? (a["data-href"] = a.href, delete a.href, Ye("style", e, a, true)) : Ve("style", e, a), "nr");
var ir = /* @__PURE__ */ __name(({ children: e, ...a }) => ["onLoad", "onError"].some((t) => t in a) || a.rel === "stylesheet" && (!("precedence" in a) || "disabled" in a) ? Ve("link", e, a) : Ye("link", e, a, "precedence" in a), "ir");
var cr = /* @__PURE__ */ __name(({ children: e, ...a }) => {
  const t = Ia();
  return t && Ae(t) === "head" ? Ve("meta", e, a) : Ye("meta", e, a, false);
}, "cr");
var Tt = /* @__PURE__ */ __name((e, { children: a, ...t }) => new W(e, t, ze(a ?? [])), "Tt");
var lr = /* @__PURE__ */ __name((e) => (typeof e.action == "function" && (e.action = oa in e.action ? e.action[oa] : void 0), Tt("form", e)), "lr");
var St = /* @__PURE__ */ __name((e, a) => (typeof a.formAction == "function" && (a.formAction = oa in a.formAction ? a.formAction[oa] : void 0), Tt(e, a)), "St");
var dr = /* @__PURE__ */ __name((e) => St("input", e), "dr");
var ur = /* @__PURE__ */ __name((e) => St("button", e), "ur");
...
var na = /* @__PURE__ */ __name((e) => fr.get(e) || e, "na");
var yt = /* @__PURE__ */ __name((e, a) => {
...
var Pe = void 0;
var Ia = /* @__PURE__ */ __name(() => Pe, "Ia");
var pr = /* @__PURE__ */ __name((e) => /[A-Z]/.test(e) && e.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/) ? e.replace(/([A-Z])/g, "-$1").toLowerCase() : e, "pr");
...
var Ea = /* @__PURE__ */ __name(class extends W {
  toStringToBuffer(e) {
...
var Rt = /* @__PURE__ */ __name(class extends W {
  toStringToBuffer(e) {
    ja(this.children, e);
  }
}, "Rt");
var $a = /* @__PURE__ */ __name((e, a, ...t) => {
...
var mr = /* @__PURE__ */ __name(({ children: e }) => new Rt("", { children: e }, Array.isArray(e) ? e : e ? [e] : []), "mr");
function R(e, a, t) {
  let r;
  if (!a || !("children" in a))
    r = Qe(e, a, []);
...
__name(R, "R");
var ka = /* @__PURE__ */ __name((e, a, t) => (r, s) => {
  let o = -1;
  return n(0);
  async function n(i) {
    if (i <= o)
...
var gr = Symbol();
var _r = /* @__PURE__ */ __name(async (e, a = /* @__PURE__ */ Object.create(null)) => {
...
var Dr = /* @__PURE__ */ __name((e) => da(e, decodeURI), "Dr");
...
var Te = /* @__PURE__ */ __name((e, a, ...t) => (t.length && (a = Te(a, ...t)), `${(e == null ? void 0 : e[0]) === "/" ? "" : "/"}${e}${a === "/" ? "" : `${(e == null ? void 0 : e.at(-1)) === "/" ? "" : "/"}${(a == null ? void 0 : a[0]) === "/" ? a.slice(1) : a}`}`), "Te");
...
var ha = /* @__PURE__ */ __name((e) => /[%+]/.test(e) ? (e.indexOf("+") !== -1 && (e = e.replace(/\+/g, " ")), e.indexOf("%") !== -1 ? da(e, La) : e) : e, "ha");
var Dt = /* @__PURE__ */ __name((e, a, t) => {
  let r;
  if (!t && a && !/[%+]/.test(a)) {
    let n = e.indexOf(`?${a}`, 8);
...
var wr = Dt;
var Ar = /* @__PURE__ */ __name((e, a) => Dt(e, a, true), "Ar");
var La = decodeURIComponent;
var za = /* @__PURE__ */ __name((e) => da(e, La), "za");
var Re;
var U;
var K;
var wt;
...
var Q;
var st;
var bt = (st = /* @__PURE__ */ __name(class {
  constructor(e, a = "/", t = [[]]) {
    O(this, K);
    T(this, "raw");
    O(this, Re);
...
}, "st"), Re = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakSet(), wt = /* @__PURE__ */ __name(function(e) {
  const a = u(this, U)[0][this.routeIndex][1][e], t = C(this, K, Na).call(this, a);
  return t && /\%/.test(t) ? za(t) : t;
}, "wt"), At = /* @__PURE__ */ __name(function() {
...
var Se;
var ot;
var jr = (ot = /* @__PURE__ */ __name(class {
  constructor(e, a) {
    O(this, ee);
    O(this, Be);
    O(this, qe);
    ...
    T(this, "html", (e2, a2, t) => {
      const r = /* @__PURE__ */ __name((s) => C(this, ee, Se).call(this, s, a2, ma("text/html; charset=UTF-8", t)), "r");
...
}, "ot"), Be = /* @__PURE__ */ new WeakMap(), qe = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakMap(), Oe = /* @__PURE__ */ new WeakMap(), Y = /* @__PURE__ */ new WeakMap(), H = /* @__PURE__ */ new WeakMap(), Fe = /* @__PURE__ */ new WeakMap(), Ne = /* @__PURE__ */ new WeakMap(), Ce = /* @__PURE__ */ new WeakMap(), ue = /* @__PURE__ */ new WeakMap(), $e = /* @__PURE__ */ new WeakMap(), We = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakSet(), Se = /* @__PURE__ */ __name(function(e, a, t) {
...
var aa;
var nt;
var Lt = (nt = /* @__PURE__ */ __name(class {
  constructor(a = {}) {
    O(this, A);
    T(this, "get");
    T(this, "post");
  ...
  route(a, t) {
    ...
    return t.routes.map((s) => {
      var n;
      let o;
      t.errorHandler === Va ? o = s.handler : (o = /* @__PURE__ */ __name(async (i, c) => (await ka([], t.errorHandler)(i, () => s.handler(i, c))).res, "o"), o[xr] = s.handler), C(n = r, A, ce).call(n, s.method, s.path, o);
    }), this;
  }
  basePath(a) {
  ...
  mount(a, t, r) {
    let s, o;
    r && (typeof r == "function" ? o = r : (o = r.optionHandler, r.replaceRequest === false ? s = /* @__PURE__ */ __name((c) => c, "s") : s = r.replaceRequest));
    const n = o ? (c) => {
      const l = o(c);
...
}, "nt"), q = /* @__PURE__ */ new WeakMap(), A = /* @__PURE__ */ new WeakSet(), Mt = /* @__PURE__ */ __name(function() {
...
}, "Mt"), F = /* @__PURE__ */ new WeakMap(), ce = /* @__PURE__ */ __name(function(a, t, r) {
...
}, "ce"), ea = /* @__PURE__ */ __name(function(a, t) {
  if (a instanceof Error)
    return this.errorHandler(a, t);
  throw a;
}, "ea"), aa = /* @__PURE__ */ __name(function(a, t, r, s) {
  if (s === "HEAD")
...
var xt = [];
function Hr(e, a) {
  const t = this.buildAllMatchers(), r = /* @__PURE__ */ __name((s, o) => {
...
var $;
var it;
var Ca = (it = /* @__PURE__ */ __name(class {
  constructor() {
    O(this, fe);
    O(this, pe);
...
var ke;
var ct;
var qr = (ct = /* @__PURE__ */ __name(class {
  constructor() {
...
var Ht;
var lt;
var kr = (lt = /* @__PURE__ */ __name(class {
  constructor() {
    O(this, la);
...
}, "lt"), ae = /* @__PURE__ */ new WeakMap(), te = /* @__PURE__ */ new WeakMap(), la = /* @__PURE__ */ new WeakSet(), Ht = /* @__PURE__ */ __name(function(e) {
  const a = [];
  let t = e === w;
...
var G;
var dt;
var zr = (dt = /* @__PURE__ */ __name(class {
  constructor(e) {
...
var le;
var ut;
var Ut = (ut = /* @__PURE__ */ __name(class {
  constructor(e, a, t) {
    O(this, J);
    O(this, se);
    O(this, x);
...
}, "ut"), se = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakMap(), Ee = /* @__PURE__ */ new WeakMap(), De = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), J = /* @__PURE__ */ new WeakSet(), le = /* @__PURE__ */ __name(function(e, a, t, r) {
  const s = [];
...
var he;
var ft;
var Vr = (ft = /* @__PURE__ */ __name(class {
  constructor() {
...
var X = /* @__PURE__ */ __name(class extends Lt {
  constructor(e = {}) {
...
var as = /* @__PURE__ */ __name(async (e, a) => {
  let t;
...
var ts = /* @__PURE__ */ __name((e) => async function(t, r) {
...
var Ja = /* @__PURE__ */ __name((e, a) => we && e instanceof SVGElement && /[A-Z]/.test(a) && (a in e.style || a.match(/^(?:o|pai|str|u|ve)/)) ? a.replace(/([A-Z])/g, "-$1").toLowerCase() : a, "Ja");
var is = /* @__PURE__ */ __name((e, a, t) => {
  var r;
  a || (a = {});
  for (let s in a) {
    const o = a[s];
    if (s !== "children" && (!t || t[s] !== o)) {
      ...
      if (n) {
        ...
        let i;
        typeof o == "function" ? i = o(e) || (() => o(null)) : o && "current" in o && (o.current = e, i = /* @__PURE__ */ __name(() => o.current = null, "i")), Da.set(e, i);
      } else if (s === "style") {
        const i = e.style;
...
var qt = /* @__PURE__ */ __name((e, a, t, r, s) => {
  var o, n;
...
var $t = /* @__PURE__ */ __name((e, a, t) => {
  e.c = a, Wt(e, a, t);
}, "$t");
var Ka = /* @__PURE__ */ __name((e, a) => {
  if (a) {
    for (let t = 0, r = e.length; t < r; t++)
      if (e[t] === a)
        return t;
...
var ds = /* @__PURE__ */ __name((e, a) => !!(e && e.length === a.length && e.every((t, r) => t[1] === a[r][1])), "ds");
var ra = /* @__PURE__ */ new WeakMap();
var ba = /* @__PURE__ */ __name((e, a, t) => {
  var o, n, i, c, l, d;
  const r = !t && a.pC;
  t && (a.pC || (a.pC = a.vC));
  let s;
  try {
    ...
    if (h) {
      const E = /* @__PURE__ */ __name(() => sa([0, false, e[2]], m), "E"), g = ra.get(m) || [];
      g.push(E), ra.set(m, g);
      const _ = h(f, () => {
        const v = ra.get(m);
        if (v) {
...
var Qa = [];
var sa = /* @__PURE__ */ __name(async (e, a) => {
  e[5] || (e[5] = []);
  const t = Le.get(a);
  t && t[0](void 0);
  let r;
...
var fs = /* @__PURE__ */ __name((e, a, t) => ({ tag: He, props: { children: e }, key: t, e: a, p: 1 }), "fs");
var _a = 0;
var kt = 1;
var va = 2;
var Ta = 3;
var Sa = /* @__PURE__ */ new WeakMap();
var zt = /* @__PURE__ */ __name((e, a) => !e || !a || e.length !== a.length || a.some((t, r) => t !== e[r]), "zt");
var ps = void 0;
var et = [];
var Es = /* @__PURE__ */ __name((e) => {
  var n;
  const a = /* @__PURE__ */ __name(() => typeof e == "function" ? e() : e, "a"), t = Ue.at(-1);
  if (!t)
    return [a(), () => {
    }];
...
var xa = /* @__PURE__ */ __name((e, a) => ms(() => (t) => {
  let r;
  e && (typeof e == "function" ? r = e(t) || (() => {
    e(null);
  }) : e && "current" in e && (e.current = t, r = /* @__PURE__ */ __name(() => {
    e.current = null;
  }, "r")));
  const s = a(t);
  return () => {
...
var Ge = /* @__PURE__ */ __name((e, a, t, r, s) => {
...
var Ts = /* @__PURE__ */ __name((e) => !e || ["src", "async"].some((a) => !e[a]) ? { tag: "script", props: e, type: "script", ref: e.ref } : Ge("script", e, 1, false, true), "Ts");
var Ss = /* @__PURE__ */ __name((e) => !e || !["href", "precedence"].every((a) => a in e) ? { tag: "style", props: e, type: "style", ref: e.ref } : (e["data-href"] = e.href, delete e.href, Ge("style", e, 2, true, true)), "Ss");
var ys = /* @__PURE__ */ __name((e) => !e || ["onLoad", "onError"].some((a) => a in e) || e.rel === "stylesheet" && (!("precedence" in e) || "disabled" in e) ? { tag: "link", props: e, type: "link", ref: e.ref } : Ge("link", e, 1, "precedence" in e, true), "ys");
var Rs = /* @__PURE__ */ __name((e) => Ge("meta", e, void 0, false, false), "Rs");
var Vt = Symbol();
...
var Yt = /* @__PURE__ */ __name((e, { formAction: a, ...t }) => {
...
var ya = /* @__PURE__ */ __name((e, a, t) => (a = encodeURIComponent(a), xs(e, a, t)), "ya");
var Pa = /* @__PURE__ */ __name((e, a, t) => {
...
var Kt = /* @__PURE__ */ __name((e, a, t, r) => {
  const s = Ps(a, t, r);
...
// ../.wrangler/tmp/bundle-uooHqW/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-uooHqW/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.3586651497003114.mjs.map
