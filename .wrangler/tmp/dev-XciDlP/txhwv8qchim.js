...
// .wrangler/tmp/bundle-3JlNyB/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-0mKwis/bundledWorker-0.19695127777842858.mjs
...
var g = /* @__PURE__ */ __name2((e, t, r) => Zr(e, typeof t != "symbol" ? t + "" : t, r), "g");
var ut = /* @__PURE__ */ __name2((e, t, r) => t.has(e) || Ht("Cannot " + r), "ut");
var f = /* @__PURE__ */ __name2((e, t, r) => (ut(e, t, "read from private field"), r ? r.call(e) : t.get(e)), "f");
...
var vr = /* @__PURE__ */ __name2((e) => ({ value: t, children: r }) => {
  if (!r)
    return;
...
var qt = /* @__PURE__ */ __name2((e, t, r, a) => ({ buffer: s, context: n }) => {
  ...
  if (c ? s[0] = s[0].replaceAll(t, "") : l.length > 0 ? i.push([t, r, a]) : i.unshift([t, r, a]), s[0].indexOf("</head>") !== -1) {
    ...
    if (a === void 0)
      ...
      d = i.map(([u, , E]) => {
        let v = p.indexOf(E);
        return v === -1 && (p.push(E), v = p.length - 1), [u, v];
      }).sort((u, E) => u[1] - E[1]).map(([u]) => u);
    }
    d.forEach((p) => {
...
var Ve = /* @__PURE__ */ __name2((e, t, r) => U(new F(e, r, ze(t ?? [])).toString()), "Ve");
var Je = /* @__PURE__ */ __name2((e, t, r, a) => {
  if ("itemProp" in r)
    return Ve(e, t, r);
  let { precedence: s, blocking: n, ...o } = r;
  s = a ? s ?? "" : void 0, a && (o[Ze] = s);
  const i = new F(e, o, ze(t || [])).toString();
...
var ra = /* @__PURE__ */ __name2(({ children: e, ...t }) => {
  ...
  if (r) {
    const a = Ae(r);
    if (a === "svg" || a === "head")
      return new F("title", t, ze(e ?? []));
  }
  return Je("title", e, t, false);
}, "ra");
var aa = /* @__PURE__ */ __name2(({ children: e, ...t }) => {
  const r = jt();
  return ["src", "async"].some((a) => !t[a]) || r && Ae(r) === "head" ? Ve("script", e, t) : Je("script", e, t, false);
}, "aa");
var sa = /* @__PURE__ */ __name2(({ children: e, ...t }) => ["href", "precedence"].every((r) => r in t) ? (t["data-href"] = t.href, delete t.href, Je("style", e, t, true)) : Ve("style", e, t), "sa");
var na = /* @__PURE__ */ __name2(({ children: e, ...t }) => ["onLoad", "onError"].some((r) => r in t) || t.rel === "stylesheet" && (!("precedence" in t) || "disabled" in t) ? Ve("link", e, t) : Je("link", e, t, "precedence" in t), "na");
var oa = /* @__PURE__ */ __name2(({ children: e, ...t }) => {
  const r = jt();
  return r && Ae(r) === "head" ? Ve("meta", e, t) : Je("meta", e, t, false);
}, "oa");
var _r = /* @__PURE__ */ __name2((e, { children: t, ...r }) => new F(e, r, ze(t ?? [])), "_r");
var ia = /* @__PURE__ */ __name2((e) => (typeof e.action == "function" && (e.action = nt in e.action ? e.action[nt] : void 0), _r("form", e)), "ia");
var yr = /* @__PURE__ */ __name2((e, t) => (typeof t.formAction == "function" && (t.formAction = nt in t.formAction ? t.formAction[nt] : void 0), _r(e, t)), "yr");
var ca = /* @__PURE__ */ __name2((e) => yr("input", e), "ca");
var la = /* @__PURE__ */ __name2((e) => yr("button", e), "la");
  ...
  for (let r = 0, a = e.length; r < a; r++) {
    ...
    if (typeof s == "string")
      ...
      if (typeof s == "boolean" || s === null || s === void 0)
        continue;
      s instanceof F ? s.toStringToBuffer(t) : typeof s == "number" || s.isEscaped ? t[0] += s : s instanceof Promise ? t.unshift("", s) : At(s, t);
    }
  }
}, "At");
var F = /* @__PURE__ */ __name2(class {
  constructor(e, t, r) {
    g(this, "tag");
    g(this, "props");
    g(this, "key");
...
var pt = /* @__PURE__ */ __name2(class extends F {
  toStringToBuffer(e) {
    ...
    if (!(typeof r == "boolean" || r == null))
      if (r instanceof Promise)
        if (Ce.length === 0)
          ...
          e.unshift("", r.then((s) => (s instanceof F && (s.localContexts = a), s)));
        }
      else
        r instanceof F ? r.toStringToBuffer(e) : typeof r == "number" || r.isEscaped ? (e[0] += r, r.callbacks && (e.callbacks || (e.callbacks = []), e.callbacks.push(...r.callbacks))) : se(r, e);
  }
}, "pt");
var Rr = /* @__PURE__ */ __name2(class extends F {
  toStringToBuffer(e) {
    At(this.children, e);
  }
}, "Rr");
...
var Qe = /* @__PURE__ */ __name2((e, t, r) => {
  ...
  return typeof e == "function" ? new pt(e, t, r) : ft[e] ? new pt(ft[e], t, r) : e === "svg" || e === "head" ? (He || (He = Dt("")), new F(e, t, [new pt(He, { value: e }, r)])) : new F(e, t, r);
}, "Qe");
...
__name(S, "S");
__name2(S, "S");
var $t = /* @__PURE__ */ __name2((e, t, r) => (a, s) => {
  let n = -1;
  return o(0);
  async function o(i) {
    if (i <= n)
...
var Na = Or;
var Ca = /* @__PURE__ */ __name2((e, t) => Or(e, t, true), "Ca");
...
var Z;
var ar;
var Nr = (ar = /* @__PURE__ */ __name2(class {
  constructor(e, t = "/", r = [[]]) {
    R(this, K);
    g(this, "raw");
    R(this, Se);
  ...
  param(e) {
    return e ? O(this, K, Cr).call(this, e) : O(this, K, Dr).call(this);
  }
  query(e) {
  ...
  get matchedRoutes() {
    return f(this, P)[0].map(([[, e]]) => e);
  }
  get routePath() {
    return f(this, P)[0].map(([[, e]]) => e)[this.routeIndex].path;
  }
}, "ar"), Se = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakSet(), Cr = /* @__PURE__ */ __name2(function(e) {
  const t = f(this, P)[0][this.routeIndex][1][e], r = O(this, K, wt).call(this, t);
  return r && /\%/.test(r) ? Wt(r) : r;
}, "Cr"), Dr = /* @__PURE__ */ __name2(function() {
  const e = {}, t = Object.keys(f(this, P)[0][this.routeIndex][1]);
  for (const r of t) {
    const a = O(this, K, wt).call(this, f(this, P)[0][this.routeIndex][1][r]);
    a !== void 0 && (e[r] = /\%/.test(a) ? Wt(a) : a);
  }
  return e;
}, "Dr"), wt = /* @__PURE__ */ __name2(function(e) {
  return f(this, P)[1] ? f(this, P)[1][e] : e;
...
var Te;
var sr;
var ja = (sr = /* @__PURE__ */ __name2(class {
  constructor(e, t) {
    R(this, Q);
    R(this, Be);
    R(this, qe);
    ...
    R(this, Fe);
    R(this, $e);
    g(this, "render", (...e2) => (f(this, be) ?? y(this, be, (t2) => this.html(t2)), f(this, be).call(this, ...e2)));
    g(this, "setLayout", (e2) => y(this, ke, e2));
    g(this, "getLayout", () => f(this, ke));
    g(this, "setRenderer", (e2) => {
      y(this, be, e2);
    });
    g(this, "header", (e2, t2, r) => {
      this.finalized && y(this, L, new Response(f(this, L).body, f(this, L)));
      const a = f(this, L) ? f(this, L).headers : f(this, de) ?? y(this, de, new Headers());
    ...
    g(this, "set", (e2, t2) => {
      f(this, V) ?? y(this, V, /* @__PURE__ */ new Map()), f(this, V).set(e2, t2);
    });
    g(this, "get", (e2) => f(this, V) ? f(this, V).get(e2) : void 0);
    g(this, "newResponse", (...e2) => O(this, Q, Te).call(this, ...e2));
    g(this, "body", (e2, t2, r) => O(this, Q, Te).call(this, e2, t2, r));
    g(this, "text", (e2, t2, r) => !f(this, de) && !f(this, we) && !t2 && !r && !this.finalized ? new Response(e2) : O(this, Q, Te).call(this, e2, t2, mt(Da, r)));
    g(this, "json", (e2, t2, r) => O(this, Q, Te).call(this, JSON.stringify(e2), t2, mt("application/json", r)));
    g(this, "html", (e2, t2, r) => {
      const a = /* @__PURE__ */ __name2((s) => O(this, Q, Te).call(this, s, t2, mt("text/html; charset=UTF-8", r)), "a");
    ...
    g(this, "notFound", () => (f(this, Oe) ?? y(this, Oe, () => new Response()), f(this, Oe).call(this, this)));
    y(this, Be, e), t && (y(this, J, t.executionCtx), this.env = t.env, y(this, Oe, t.notFoundHandler), y(this, $e, t.path), y(this, Fe, t.matchResult));
  }
  get req() {
    return f(this, qe) ?? y(this, qe, new Nr(f(this, Be), f(this, $e), f(this, Fe))), f(this, qe);
  }
  get event() {
    if (f(this, J) && "respondWith" in f(this, J))
      return f(this, J);
  ...
  get res() {
    return f(this, L) || y(this, L, new Response(null, { headers: f(this, de) ?? y(this, de, new Headers()) }));
  }
  set res(e) {
    if (f(this, L) && e) {
      e = new Response(e.body, e);
      for (const [t, r] of f(this, L).headers.entries())
        if (t !== "content-type")
          if (t === "set-cookie") {
            const a = f(this, L).headers.getSetCookie();
  ...
  get var() {
    return f(this, V) ? Object.fromEntries(f(this, V)) : {};
  }
}, "sr"), Be = /* @__PURE__ */ new WeakMap(), qe = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakMap(), we = /* @__PURE__ */ new WeakMap(), J = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), ke = /* @__PURE__ */ new WeakMap(), be = /* @__PURE__ */ new WeakMap(), Oe = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ new WeakMap(), Fe = /* @__PURE__ */ new WeakMap(), $e = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakSet(), Te = /* @__PURE__ */ __name2(function(e, t, r) {
  const a = f(this, L) ? new Headers(f(this, L).headers) : f(this, de) ?? new Headers();
  ...
  const s = typeof t == "number" ? t : (t == null ? void 0 : t.status) ?? f(this, we);
...
var Ir = (nr = /* @__PURE__ */ __name2(class {
  constructor(t = {}) {
    ...
    g(this, "fetch", (t2, ...r) => O(this, D, tt).call(this, t2, r[1], r[0], t2.method));
    ...
    g(this, "fire", () => {
      addEventListener("fetch", (t2) => {
        t2.respondWith(O(this, D, tt).call(this, t2.request, t2, void 0, t2.request.method));
      });
    });
    [...Ia, Aa].forEach((n) => {
      this[n] = (o, ...i) => (typeof o == "string" ? y(this, B, o) : O(this, D, ie).call(this, n, f(this, B), o), i.forEach((c) => {
        O(this, D, ie).call(this, n, f(this, B), c);
      }), this);
    }), this.on = (n, o, ...i) => {
      for (const c of [o].flat()) {
        ...
        for (const l of [n].flat())
          i.map((d) => {
            O(this, D, ie).call(this, l.toUpperCase(), f(this, B), d);
          });
      }
      return this;
    }, this.use = (n, ...o) => (typeof n == "string" ? y(this, B, n) : (y(this, B, "*"), o.unshift(n)), o.forEach((i) => {
      O(this, D, ie).call(this, C, f(this, B), i);
    }), this);
    const { strict: a, ...s } = t;
    Object.assign(this, s), this.getPath = a ?? true ? t.getPath ?? wr : Oa;
  }
  route(t, r) {
    ...
    return r.routes.map((s) => {
      var o;
      let n;
      r.errorHandler === zt ? n = s.handler : (n = /* @__PURE__ */ __name2(async (i, c) => (await $t([], r.errorHandler)(i, () => s.handler(i, c))).res, "n"), n[xa] = s.handler), O(o = a, D, ie).call(o, s.method, s.path, n);
    }), this;
  }
  basePath(t) {
    const r = O(this, D, xr).call(this);
  ...
  mount(t, r, a) {
    ...
    return O(this, D, ie).call(this, C, ye(t, "*"), i), this;
  }
}, "nr"), B = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakSet(), xr = /* @__PURE__ */ __name2(function() {
  const t = new Ir({ router: this.router, getPath: this.getPath });
  return t.errorHandler = this.errorHandler, y(t, q, f(this, q)), t.routes = this.routes, t;
}, "xr"), q = /* @__PURE__ */ new WeakMap(), ie = /* @__PURE__ */ __name2(function(t, r, a) {
  ...
  if (s === "HEAD")
    return (async () => new Response(null, await O(this, D, tt).call(this, t, r, a, "GET")))();
  const n = this.getPath(t, { env: a }), o = this.router.match(s, n), i = new ja(t, { path: n, matchResult: o, env: a, executionCtx: r, notFoundHandler: f(this, q) });
  if (o[0].length === 1) {
    let l;
    try {
      l = o[0][0][0][0](i, async () => {
        i.res = await f(this, q).call(this, i);
      });
    } catch (d) {
      return O(this, D, et).call(this, d, i);
    }
    return l instanceof Promise ? l.then((d) => d || (i.finalized ? i.res : f(this, q).call(this, i))).catch((d) => O(this, D, et).call(this, d, i)) : l ?? f(this, q).call(this, i);
  }
  const c = $t(o[0], this.errorHandler, f(this, q));
  return (async () => {
    try {
      const l = await c(i);
      if (!l.finalized)
      ...
      return O(this, D, et).call(this, l, i);
    }
  })();
}, "tt"), nr);
var it = "[^/]+";
...
var k;
var or;
var bt = (or = /* @__PURE__ */ __name2(class {
  constructor() {
    R(this, ue);
    R(this, fe);
    R(this, k, /* @__PURE__ */ Object.create(null));
  }
  insert(t, r, a, s, n) {
    if (t.length === 0) {
      if (f(this, ue) !== void 0)
    ...
    if (c) {
      ...
      if (d && c[2] && (p === ".*" || (p = p.replace(/^\((?!\?:)(?=[^)]+\)$)/, "(?:"), /\((?!\?:)/.test(p))))
        throw Re;
      if (l = f(this, k)[p], !l) {
        if (Object.keys(f(this, k)).some((u) => u !== Me && u !== Le))
          throw Re;
        if (n)
          return;
        l = f(this, k)[p] = new bt(), d !== "" && y(l, fe, s.varIndex++);
      }
      !n && d !== "" && a.push([d, f(l, fe)]);
    } else if (l = f(this, k)[o], !l) {
      if (Object.keys(f(this, k)).some((d) => d.length > 1 && d !== Me && d !== Le))
        throw Re;
      if (n)
        return;
      l = f(this, k)[o] = new bt();
  ...
  buildRegExpStr() {
    const r = Object.keys(f(this, k)).sort(Ha).map((a) => {
      const s = f(this, k)[a];
      return (typeof f(s, fe) == "number" ? `(${a})@${f(s, fe)}` : La.has(a) ? `\\${a}` : a) + s.buildRegExpStr();
    });
    return typeof f(this, ue) == "number" && r.unshift(`#${f(this, ue)}`), r.length === 0 ? "" : r.length === 1 ? r[0] : "(?:" + r.join("|") + ")";
  }
}, "or"), ue = /* @__PURE__ */ new WeakMap(), fe = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), or);
var ct;
var We;
var ir;
var Pa = (ir = /* @__PURE__ */ __name2(class {
  ...
  insert(e, t, r) {
    ...
    return f(this, We).insert(n, t, a, f(this, ct), r), a;
  }
  buildRegExp() {
    let e = f(this, We).buildRegExpStr();
    if (e === "")
      return [/^$/, [], []];
    let t = 0;
    const r = [], a = [];
...
function qa(e) {
  ...
  if (e.length === 0)
    return Ua;
  const a = e.map((d) => [!/\*|\/:/.test(d[0]), ...d]).sort(([d, p], [u, E]) => d ? 1 : u ? -1 : p.length - E.length), s = /* @__PURE__ */ Object.create(null);
  ...
  for (let d = 0, p = r.length; d < p; d++)
    for (let u = 0, E = r[d].length; u < E; u++) {
      const v = (l = r[d][u]) == null ? void 0 : l[1];
      if (!v)
        continue;
...
var Pr;
var cr;
var ka = (cr = /* @__PURE__ */ __name2(class {
  constructor() {
    R(this, je);
  ...
  add(e, t, r) {
    ...
    for (let c = 0, l = o.length; c < l; c++) {
      ...
      Object.keys(s).forEach((p) => {
        var u;
        (e === C || e === p) && ((u = s[p])[d] || (u[d] = [...ge(a[p], d) || ge(a[C], d) || []]), s[p][d].push([r, n - l + c + 1]));
      });
    }
  }
  match(e, t) {
    Ba();
    const r = O(this, je, Hr).call(this);
...
}, "cr"), ee = /* @__PURE__ */ new WeakMap(), te = /* @__PURE__ */ new WeakMap(), je = /* @__PURE__ */ new WeakSet(), Hr = /* @__PURE__ */ __name2(function() {
  const e = /* @__PURE__ */ Object.create(null);
  return Object.keys(f(this, te)).concat(Object.keys(f(this, ee))).forEach((t) => {
    e[t] || (e[t] = O(this, je, Pr).call(this, t));
  }), y(this, ee, y(this, te, void 0)), e;
}, "Hr"), Pr = /* @__PURE__ */ __name2(function(e) {
  const t = [];
  let r = e === C;
  return [f(this, ee), f(this, te)].forEach((a) => {
...
var Y;
var lr;
var Fa = (lr = /* @__PURE__ */ __name2(class {
  constructor(e) {
  ...
  match(e, t) {
    ...
    const r = f(this, re), a = f(this, Y), s = r.length;
    let n = 0, o;
    for (; n < s; n++) {
      const i = r[n];
      try {
      ...
      this.match = i.match.bind(i), y(this, re, [i]), y(this, Y, void 0);
      break;
    }
    if (n === s)
      throw new Error("Fatal error");
  ...
  get activeRouter() {
    if (f(this, Y) || f(this, re).length !== 1)
      throw new Error("No active router has been determined yet.");
    return f(this, re)[0];
  }
}, "lr"), re = /* @__PURE__ */ new WeakMap(), Y = /* @__PURE__ */ new WeakMap(), lr);
...
var Ur = (dr = /* @__PURE__ */ __name2(class {
  ...
  insert(e, t, r) {
    ...
    for (let o = 0, i = s.length; o < i; o++) {
      ...
      if (p in f(a, x)) {
        a = f(a, x)[p], d && n.push(d[1]);
        continue;
      }
      f(a, x)[p] = new Ur(), d && (f(a, pe).push(d), n.push(d[1])), a = f(a, x)[p];
    }
    return f(a, ae).push({ [e]: { handler: r, possibleKeys: n.filter((o, i, c) => c.indexOf(o) === i), score: f(this, Ne) } }), a;
  }
  search(e, t) {
    var i;
    const r = [];
    ...
    for (let c = 0, l = n.length; c < l; c++) {
      const d = n[c], p = c === l - 1, u = [];
      for (let E = 0, v = s.length; E < v; E++) {
        const h = s[E], m = f(h, x)[d];
        m && (y(m, j, f(h, j)), p ? (f(m, x)["*"] && r.push(...O(this, G, ce).call(this, f(m, x)["*"], e, f(h, j))), r.push(...O(this, G, ce).call(this, m, e, f(h, j)))) : u.push(m));
        for (let _ = 0, T = f(h, pe).length; _ < T; _++) {
          const b = f(h, pe)[_], w = f(h, j) === Ie ? {} : { ...f(h, j) };
          if (b === "*") {
            const X = f(h, x)["*"];
            X && (r.push(...O(this, G, ce).call(this, X, e, f(h, j))), y(X, j, w), u.push(X));
            continue;
          }
          const [I, ve, oe] = b;
          if (!d && !(oe instanceof RegExp))
            continue;
          const W = f(h, x)[I], Kr = n.slice(c).join("/");
          if (oe instanceof RegExp) {
            const X = oe.exec(Kr);
            if (X) {
              if (w[ve] = X[0], r.push(...O(this, G, ce).call(this, W, e, f(h, j), w)), Object.keys(f(W, x)).length) {
                y(W, j, w);
          ...
          (oe === true || oe.test(d)) && (w[ve] = d, p ? (r.push(...O(this, G, ce).call(this, W, e, w, f(h, j))), f(W, x)["*"] && r.push(...O(this, G, ce).call(this, f(W, x)["*"], e, w, f(h, j)))) : (y(W, j, w), u.push(W)));
        }
      }
      s = u.concat(o.shift() ?? []);
    }
...
}, "dr"), ae = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakMap(), Ne = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakSet(), ce = /* @__PURE__ */ __name2(function(e, t, r, a) {
  const s = [];
  for (let n = 0, o = f(e, ae).length; n < o; n++) {
    const i = f(e, ae)[n], c = i[t] || i[C], l = {};
    if (c !== void 0 && (c.params = /* @__PURE__ */ Object.create(null), s.push(c), r !== Ie || a && a !== Ie))
      for (let d = 0, p = c.possibleKeys.length; d < p; d++) {
        const u = c.possibleKeys[d], E = l[c.score];
        c.params[u] = a != null && a[u] && !E ? a[u] : r[u] ?? (a == null ? void 0 : a[u]), l[c.score] = true;
      }
  }
  return s;
}, "ce"), dr);
var he;
var ur;
var $a = (ur = /* @__PURE__ */ __name2(class {
  constructor() {
  ...
  add(e, t, r) {
    ...
    if (a) {
      for (let s = 0, n = a.length; s < n; s++)
        f(this, he).insert(e, a[s], r);
      return;
    }
    f(this, he).insert(e, t, r);
  }
  match(e, t) {
    return f(this, he).search(e, t);
  }
}, "ur"), he = /* @__PURE__ */ new WeakMap(), ur);
var me = /* @__PURE__ */ __name2(class extends Ir {
  constructor(e = {}) {
    super(e), this.router = e.router ?? new Fa({ routers: [new ka(), new $a()] });
  }
}, "me");
var Wa = /* @__PURE__ */ __name2((e) => {
  ...
  return async function(o, i) {
    ...
    if (r.credentials && c("Access-Control-Allow-Credentials", "true"), (d = r.exposeHeaders) != null && d.length && c("Access-Control-Expose-Headers", r.exposeHeaders.join(",")), o.req.method === "OPTIONS") {
      ...
      return u != null && u.length && (c("Access-Control-Allow-Headers", u.join(",")), o.res.headers.append("Vary", "Access-Control-Request-Headers")), o.res.headers.delete("Content-Length"), o.res.headers.delete("Content-Type"), new Response(null, { headers: o.res.headers, status: 204, statusText: "No Content" });
    }
    await i();
  };
}, "Wa");
...
var Vt = /* @__PURE__ */ __name2((e, t = Ja) => {
...
var Xa = /* @__PURE__ */ __name2((e) => {
  ...
  return async (s, n) => {
    ...
    if (l) {
      ...
      return await ((u = e.onFound) == null ? void 0 : u.call(e, i, s)), s.body(l);
    }
...
var Yt = /* @__PURE__ */ __name2((e, t) => De && e instanceof SVGElement && /[A-Z]/.test(t) && (t in e.style || t.match(/^(?:o|pai|str|u|ve)/)) ? t.replace(/([A-Z])/g, "-$1").toLowerCase() : t, "Yt");
  ...
  for (let s in t) {
    ...
    if (s !== "children" && (!r || r[s] !== n)) {
      ...
      if (o) {
        ...
        let i;
        typeof n == "function" ? i = n(e) || (() => n(null)) : n && "current" in n && (n.current = e, i = /* @__PURE__ */ __name2(() => n.current = null, "i")), Ot.set(e, i);
      } else if (s === "style") {
        const i = e.style;
  ...
  if (r)
    for (let s in r) {
      ...
      if (s !== "children" && !(s in t)) {
        s = ot(s);
        const o = Jt(s);
        o ? e.removeEventListener(o[0], n, o[1]) : s === "ref" ? (a = Ot.get(e)) == null || a() : e.removeAttribute(Yt(e, s));
      }
    }
}, "ss");
...
var kr = /* @__PURE__ */ __name2((e) => {
  ...
  }), (a = Ot.get(e.e)) == null || a(), e.p === 2 && ((s = e.vC) == null || s.forEach((i) => i.p = 2)), (n = e.vC) == null || n.forEach(kr)), e.p || ((o = e.e) == null || o.remove(), delete e.e), typeof e.tag == "function" && (xe.delete(e), at.delete(e), delete e[N][3], e.a = true);
}, "kr");
...
var $r = /* @__PURE__ */ __name2((e, t, r) => {
  ...
  for (let d = 0, p = a.length; d < p; d++, i++) {
    ...
    if (u.s && u.e)
      ...
      const v = r || !u.e;
      z(u) ? (u.e && u.d && (u.e.textContent = u.t), u.d = false, E = u.e || (u.e = document.createTextNode(u.t))) : (E = u.e || (u.e = u.n ? document.createElementNS(u.n, u.tag) : document.createElement(u.tag)), ss(E, u.props, u.pP), $r(u, E, v));
    }
    u.tag === Pe ? i-- : r ? E.parentNode || t.appendChild(E) : o[i] !== E && o[i - 1] !== E && (o[i + 1] === E ? t.appendChild(o[i]) : t.insertBefore(E, c || o[i] || null));
  }
  if (e.pP && delete e.pP, n.length) {
    const d = [], p = [];
    n.forEach(([, u, , E, v]) => {
      u && d.push(u), E && p.push(E), v == null || v();
    }), d.forEach((u) => u()), p.length && requestAnimationFrame(() => {
      p.forEach((u) => u());
    });
  }
}, "$r");
...
var Nt = /* @__PURE__ */ __name2((e, t, r) => {
  ...
  try {
    ...
    const p = a ? [...t.pC] : t.vC ? [...t.vC] : void 0, u = [];
    let E;
    for (let v = 0; v < r.length; v++) {
      ...
      if (h) {
        ...
        if (!z(h) && !h.s && (Nt(e, h), delete h.f), u.push(h), E && !E.s && !h.s)
          for (let _ = E; _ && !z(_); _ = (l = _.vC) == null ? void 0 : l.at(-1))
            _.nN = h;
        E = h;
      }
    }
    t.vR = a ? [...t.vC, ...p || []] : p || [], t.vC = u, a && delete t.pC;
  } catch (p) {
    if (t.f = true, p === Kt) {
      if (s)
        return;
    ...
    const [u, E, v] = ((d = t[N]) == null ? void 0 : d[3]) || [];
    if (E) {
      const h = /* @__PURE__ */ __name2(() => st([0, false, e[2]], v), "h"), m = at.get(v) || [];
      m.push(h), at.set(v, m);
      const _ = E(p, () => {
        const T = at.get(v);
        if (T) {
          const b = T.indexOf(h);
          if (b !== -1)
            return T.splice(b, 1), h();
        }
      });
      if (_) {
        if (e[0] === 1)
          e[1] = true;
        else if (Nt(e, v, [_]), (E.length === 1 || e !== u) && v.c) {
          Fr(v, v.c, false);
          return;
        }
        throw Kt;
...
var us = /* @__PURE__ */ __name2((e) => {
  ...
  return s[n] || (s[n] = [t(), (i) => {
    ...
    if (typeof i == "function" && (i = i(l[0])), !Object.is(i, l[0]))
      if (l[0] = i, Qt.length) {
        const [d, p] = Qt.at(-1);
        Promise.all([d === 3 ? a : st([d, false, c], a), p]).then(([u]) => {
          if (!u || !(d === 2 || d === 3))
            return;
          const E = u.vC;
          requestAnimationFrame(() => {
            setTimeout(() => {
              E === u.vC && st([d === 3 ? 1 : 0, false, c], u);
            });
          });
        });
      } else
...
var Mt = /* @__PURE__ */ __name2((e, t) => ps(() => (r) => {
  let a;
...
var Ye = /* @__PURE__ */ __name2((e, t, r, a, s) => {
  if (t != null && t.itemProp)
    return { tag: e, props: t, type: e, ref: t.ref };
  const n = document.head;
  let { onLoad: o, onError: i, precedence: c, blocking: l, ...d } = t, p = null, u = false;
  const E = Xe[e];
  let v;
  if (E.length > 0) {
    ...
    e:
      for (const b of T)
        for (const w of Xe[e])
          if (b.getAttribute(w) === t[w]) {
            p = b;
            break e;
          }
    if (!p) {
      const b = E.reduce((w, I) => t[I] === void 0 ? w : `${w}-${I}-${t[I]}`, e);
      u = !Ke[b], p = Ke[b] || (Ke[b] = (() => {
        const w = document.createElement(e);
        for (const I of E)
          t[I] !== void 0 && w.setAttribute(I, t[I]), t.rel && w.setAttribute("rel", t.rel);
        return w;
      })());
    }
  } else
  ...
  const h = xt((T) => {
    if (E.length > 0) {
      ...
      for (const w of n.querySelectorAll(e)) {
        if (b && w.getAttribute(Ze) !== c) {
          n.insertBefore(T, w);
          return;
        }
        w.getAttribute(Ze) === c && (b = true);
      }
      n.appendChild(T);
    } else if (v) {
      let b = false;
      ...
      b || n.insertBefore(T, n.contains(v[0]) ? v[0] : n.querySelector(e)), v = void 0;
    }
  }, [c]), m = Mt(t.ref, (T) => {
    var I;
    const b = E[0];
    if (r === 2 && (T.innerHTML = ""), (u || v) && h(T), !i && !o)
      return;
    let w = _e[I = T.getAttribute(b)] || (_e[I] = new Promise((ve, oe) => {
  ...
  if (s && l === "render") {
    const T = Xe[e][0];
    if (t[T]) {
      const b = t[T], w = _e[b] || (_e[b] = new Promise((I, ve) => {
        h(p), p.addEventListener("load", I), p.addEventListener("error", ve);
      }));
      fs(w);
    }
  }
...
var Es = /* @__PURE__ */ __name2((e) => {
  const t = as(), r = t && Ae(t);
  return r != null && r.endsWith("svg") ? { tag: "title", props: e, type: "title", ref: e.ref } : Ye("title", e, void 0, false, false);
}, "Es");
var vs = /* @__PURE__ */ __name2((e) => !e || ["src", "async"].some((t) => !e[t]) ? { tag: "script", props: e, type: "script", ref: e.ref } : Ye("script", e, 1, false, true), "vs");
var gs = /* @__PURE__ */ __name2((e) => !e || !["href", "precedence"].every((t) => t in e) ? { tag: "style", props: e, type: "style", ref: e.ref } : (e["data-href"] = e.href, delete e.href, Ye("style", e, 2, true, true)), "gs");
var _s = /* @__PURE__ */ __name2((e) => !e || ["onLoad", "onError"].some((t) => t in e) || e.rel === "stylesheet" && (!("precedence" in e) || "disabled" in e) ? { tag: "link", props: e, type: "link", ref: e.ref } : Ye("link", e, 1, "precedence" in e, true), "_s");
var ys = /* @__PURE__ */ __name2((e) => Ye("meta", e, void 0, false, false), "ys");
var Vr = Symbol();
var Ts = /* @__PURE__ */ __name2((e) => {
  ...
  const [a, s] = us([null, false]), n = xt(async (l) => {
    ...
    s([p, true]);
    const u = d(p);
    u instanceof Promise && (ms(u), await u), s([null, true]);
...
var Jr = /* @__PURE__ */ __name2((e, { formAction: t, ...r }) => {
...
var Rs = /* @__PURE__ */ __name2((e) => Jr("input", e), "Rs");
var Ss = /* @__PURE__ */ __name2((e) => Jr("button", e), "Ss");
...
var bs = /* @__PURE__ */ __name2((e, t, r, a) => (s, n) => {
  const o = "<!DOCTYPE html>", i = r ? kt((l) => r(l, e), { Layout: t, ...n }, s) : s, c = ea`${U(o)}${kt(ws.Provider, { value: e }, i)}`;
  return e.html(c);
}, "bs");
...
A.post("/:id/acciones", async (e) => {
  ...
  try {
    ...
    const { titulo: s, que_hacer: n, como_hacerlo: o, resultados: i, tareas_pendientes: c, tipo: l, proxima_revision: d, calificacion: p, subtareas: u = [] } = a;
    if (!s || !n)
    ...
    let v = 0;
    if (console.log("=== PROCESANDO SUB-TAREAS ===", { hasSubtareas: !!u, subtareasLength: (u == null ? void 0 : u.length) || 0, subtareasData: u }), u && u.length > 0) {
      console.log(`Procesando ${u.length} sub-tareas...`);
      for (let h = 0; h < u.length; h++) {
        ...
        if (console.log(`Sub-tarea ${h + 1}:`, m), m.titulo) {
          ...
          console.log(`\u2705 Sub-tarea ${h + 1} creada en BD:`, { success: b.success, changes: b.changes }), T && (await tr(e.env.DB, _, `[Sub] ${m.titulo}`, m.que_hacer, m.como_hacerlo, "secundaria", T), console.log(`\u2705 Sub-tarea ${h + 1} sincronizada con agenda`)), v++;
        } else
...
A.get("/:decretoId/acciones/:accionId", async (e) => {
  try {
...
A.put("/:decretoId/acciones/:accionId", async (e) => {
  try {
    ...
    `).bind(a, s, n || "", o || "", i || "secundaria", c || null, l || null, r, t).run(), await e.env.DB.prepare("SELECT id FROM agenda_eventos WHERE accion_id = ?").bind(r).first() && c) {
      const p = c.split("T")[0], u = c.split("T")[1] || "09:00";
      await e.env.DB.prepare(`
...
A.put("/:decretoId/acciones/:accionId/completar", async (e) => {
  try {
...
A.put("/:decretoId/acciones/:accionId/pendiente", async (e) => {
  try {
    const t = e.req.param("accionId");
...
A.delete("/:decretoId/acciones/:accionId", async (e) => {
  try {
    const t = e.req.param("accionId");
...
A.post("/:decretoId/acciones/:accionId/seguimientos", async (e) => {
  try {
    ...
    if (n && Array.isArray(n)) {
      for (const l of n)
        if (typeof l == "string" && l.trim()) {
          let d = l.trim(), p = "secundaria", u = null;
          ...
          E && (u = E[1] + "T09:00", d = d.replace(/@\d{4}-\d{2}-\d{2}/g, "").trim());
          ...
          if (v) {
            ...
            `).bind(v.decreto_id, d, "Tarea generada desde seguimiento", `Completar: ${d}`, p, u, `seguimiento:${t}`).run();
            let m = null;
            if (p === "secundaria") {
              const _ = u ? u.split("T")[0] : (/* @__PURE__ */ new Date()).toISOString().split("T")[0], T = u ? u.split("T")[1] : "09:00";
              ...
              p === "primaria" && u && (m = (await e.env.DB.prepare(`
                INSERT INTO agenda_eventos (accion_id, titulo, descripcion, fecha_evento, hora_evento)
                VALUES (?, ?, ?, date(?), time(?))
              `).bind(h.meta.last_row_id, `[Semanal] ${d}`, "Tarea generada desde seguimiento", u.split("T")[0], u.split("T")[1]).run()).meta.last_row_id);
            m && await e.env.DB.prepare(`
...
async function tr(e, t, r, a, s, n, o) {
  ...
  try {
    let l = null;
    if ((n || "secundaria") === "secundaria") {
      const d = o ? o.split("T")[0] : (/* @__PURE__ */ new Date()).toISOString().split("T")[0], p = o && ((i = o.split("T")[1]) == null ? void 0 : i.substring(0, 5)) || "09:00", u = crypto.randomUUID().replace(/-/g, "").substring(0, 32);
      await e.prepare(`
        INSERT INTO agenda_eventos (id, accion_id, titulo, descripcion, fecha_evento, hora_evento)
        VALUES (?, ?, ?, ?, ?, ?)
      `).bind(u, t, r, `${a || ""}${s ? " - " + s : ""}`, d, p).run(), l = u;
    } else if (n === "primaria" && o) {
      const d = crypto.randomUUID().replace(/-/g, "").substring(0, 32);
      await e.prepare(`
        INSERT INTO agenda_eventos (id, accion_id, titulo, descripcion, fecha_evento, hora_evento)
        VALUES (?, ?, ?, ?, ?, ?)
      `).bind(d, t, `[Semanal] ${r}`, `${a || ""}${s ? " - " + s : ""}`, o.split("T")[0], ((c = o.split("T")[1]) == null ? void 0 : c.substring(0, 5)) || "09:00").run(), l = d;
    }
    l && await e.prepare(`
        UPDATE acciones SET agenda_event_id = ? WHERE id = ?
      `).bind(l, t).run();
  } catch (l) {
    console.error("Error in agenda sync:", l);
  }
}
__name(tr, "tr");
__name2(tr, "tr");
A.get("/:decretoId/acciones/:accionId/arbol", async (e) => {
  try {
    const t = e.req.param("decretoId"), r = e.req.param("accionId"), a = await e.env.DB.prepare(`
...
H.put("/tareas/:id", async (e) => {
  try {
    ...
    await e.env.DB.prepare(`
      ...
      WHERE id = ?
    `).bind(r, a || "", d, p, t).run();
    const u = await e.env.DB.prepare("SELECT accion_id FROM agenda_eventos WHERE id = ?").bind(t).first();
    return u != null && u.accion_id && await e.env.DB.prepare(`
        UPDATE acciones SET 
          titulo = ?,
          que_hacer = ?,
          como_hacerlo = ?,
          ...
          updated_at = CURRENT_TIMESTAMP
        WHERE id = ?
      `).bind(r, n || "", o || "", i || "", c || "secundaria", s, l || null, u.accion_id).run(), e.json({ success: true });
  } catch {
...
H.get("/filtros", async (e) => {
  try {
    ...
    const u = await e.env.DB.prepare(l).bind(...d).all();
...
M.post("/rutinas/:id/completar", async (e) => {
  try {
...
M.delete("/rutinas/:id/completar", async (e) => {
  try {
...
M.get("/rutinas/progreso", async (e) => {
  try {
...
M.get("/rutinas/progreso-dia", async (e) => {
  try {
...
M.get("/rutinas/progreso-dia/:fecha", async (e) => {
  try {
...
M.put("/afirmaciones/:id/favorita", async (e) => {
  try {
...
M.post("/afirmaciones/:id/usar", async (e) => {
  try {
    const t = e.req.param("id");
    return await e.env.DB.prepare(`
      UPDATE afirmaciones SET 
...
M.delete("/afirmaciones/:id", async (e) => {
  try {
    const t = e.req.param("id");
...
M.get("/afirmaciones/del-dia", async (e) => {
  try {
    const t = await e.env.DB.prepare(`
...
M.post("/afirmaciones/generar", async (e) => {
  try {
...
var Tt = /* @__PURE__ */ __name2((e, t, r) => (t = encodeURIComponent(t), As(e, t, r)), "Tt");
...
$.use("/static/*", es());
$.route("/api/auth", Ee);
$.route("/api/decretos", A);
$.route("/api/agenda", H);
$.route("/api/progreso", ne);
$.route("/api/practica", M);
...
// .wrangler/tmp/pages-0mKwis/txhwv8qchim.js
...
// .wrangler/tmp/bundle-3JlNyB/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-3JlNyB/middleware-loader.entry.ts
...
//# sourceMappingURL=txhwv8qchim.js.map
