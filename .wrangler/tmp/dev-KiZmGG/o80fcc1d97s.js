...
// .wrangler/tmp/bundle-LCUy48/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-QwK9mR/bundledWorker-0.6629464490875826.mjs
...
var Zr = /* @__PURE__ */ __name2((e, t, r) => t in e ? Xr(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r, "Zr");
var v = /* @__PURE__ */ __name2((e, t, r) => Zr(e, typeof t != "symbol" ? t + "" : t, r), "v");
...
var R = /* @__PURE__ */ __name2((e, t, r) => t.has(e) ? Ht("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), "R");
...
var mr = /* @__PURE__ */ __name2(async (e, t, r, a, s) => {
...
var ea = /* @__PURE__ */ __name2((e, ...t) => {
  ...
  return r[0] += e.at(-1), r.length === 1 ? "callbacks" in r ? U(hr(U(r[0], r.callbacks))) : U(r[0]) : pr(r, r.callbacks);
}, "ea");
...
var Dt = /* @__PURE__ */ __name2((e) => {
  ...
  return r.values = t, r.Provider = r, r[Ct] = _r(t), Ce.push(r), r;
}, "Dt");
...
var qt = /* @__PURE__ */ __name2((e, t, r, a) => ({ buffer: s, context: n }) => {
  ...
  if (c ? s[0] = s[0].replaceAll(t, "") : l.length > 0 ? i.push([t, r, a]) : i.unshift([t, r, a]), s[0].indexOf("</head>") !== -1) {
    ...
    if (a === void 0)
      ...
      d = i.map(([f, , m]) => {
        let _ = p.indexOf(m);
        return _ === -1 && (p.push(m), _ = p.length - 1), [f, _];
...
var aa = /* @__PURE__ */ __name2(({ children: e, ...t }) => {
  const r = At();
  return ["src", "async"].some((a) => !t[a]) || r && je(r) === "head" ? Ve("script", e, t) : Ye("script", e, t, false);
}, "aa");
var sa = /* @__PURE__ */ __name2(({ children: e, ...t }) => ["href", "precedence"].every((r) => r in t) ? (t["data-href"] = t.href, delete t.href, Ye("style", e, t, true)) : Ve("style", e, t), "sa");
var na = /* @__PURE__ */ __name2(({ children: e, ...t }) => ["onLoad", "onError"].some((r) => r in t) || t.rel === "stylesheet" && (!("precedence" in t) || "disabled" in t) ? Ve("link", e, t) : Ye("link", e, t, "precedence" in t), "na");
var oa = /* @__PURE__ */ __name2(({ children: e, ...t }) => {
  const r = At();
  return r && je(r) === "head" ? Ve("meta", e, t) : Ye("meta", e, t, false);
}, "oa");
var vr = /* @__PURE__ */ __name2((e, { children: t, ...r }) => new $(e, r, ze(t ?? [])), "vr");
var ia = /* @__PURE__ */ __name2((e) => (typeof e.action == "function" && (e.action = nt in e.action ? e.action[nt] : void 0), vr("form", e)), "ia");
...
var ca = /* @__PURE__ */ __name2((e) => Tr("input", e), "ca");
var la = /* @__PURE__ */ __name2((e) => Tr("button", e), "la");
...
var ot = /* @__PURE__ */ __name2((e) => da.get(e) || e, "ot");
...
var ua = /* @__PURE__ */ __name2((e) => /[A-Z]/.test(e) && e.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/) ? e.replace(/([A-Z])/g, "-$1").toLowerCase() : e, "ua");
...
var $ = /* @__PURE__ */ __name2(class {
  ...
  toString() {
    ...
    return e.length === 1 ? "callbacks" in e ? hr(U(e[0], e.callbacks)).toString() : e[0] : pr(e, e.callbacks);
  }
  toStringToBuffer(e) {
    const t = this.tag, r = this.props;
    let { children: a } = this;
    e[0] += `<${t}`;
    const s = He && je(He) === "svg" ? (n) => ua(ot(n)) : (n) => ot(n);
...
var Rr = /* @__PURE__ */ __name2(class extends $ {
  toStringToBuffer(e) {
    jt(this.children, e);
  }
}, "Rr");
...
var Qe = /* @__PURE__ */ __name2((e, t, r) => {
  ...
  return typeof e == "function" ? new pt(e, t, r) : ft[e] ? new pt(ft[e], t, r) : e === "svg" || e === "head" ? (He || (He = Dt("")), new $(e, t, [new pt(He, { value: e }, r)])) : new $(e, t, r);
}, "Qe");
var ha = /* @__PURE__ */ __name2(({ children: e }) => new Rr("", { children: e }, Array.isArray(e) ? e : e ? [e] : []), "ha");
function S(e, t, r) {
  let a;
  if (!t || !("children" in t))
    a = Qe(e, t, []);
...
var Ea = /* @__PURE__ */ __name2(async (e, t = /* @__PURE__ */ Object.create(null)) => {
  ...
  return n != null && n.startsWith("multipart/form-data") || n != null && n.startsWith("application/x-www-form-urlencoded") ? _a(e, { all: r, dot: a }) : {};
}, "Ea");
...
function ga(e, t) {
  ...
  return e.forEach((a, s) => {
    t.all || s.endsWith("[]") ? va(r, s, a) : r[s] = a;
  }), t.dot && Object.entries(r).forEach(([a, s]) => {
    a.includes(".") && (Ta(r, a, s), delete r[a]);
  }), r;
}
__name(ga, "ga");
__name2(ga, "ga");
var va = /* @__PURE__ */ __name2((e, t, r) => {
  e[t] !== void 0 ? Array.isArray(e[t]) ? e[t].push(r) : e[t] = [e[t], r] : t.endsWith("[]") ? e[t] = [r] : e[t] = r;
}, "va");
var Ta = /* @__PURE__ */ __name2((e, t, r) => {
  let a = e;
  const s = t.split(".");
  s.forEach((n, o) => {
...
var Oa = /* @__PURE__ */ __name2((e) => lt(e, decodeURI), "Oa");
...
var ba = Nr;
var Ca = /* @__PURE__ */ __name2((e, t) => Nr(e, t, true), "Ca");
...
var br = (ar = /* @__PURE__ */ __name2(class {
  constructor(e, t = "/", r = [[]]) {
    ...
    this.raw = e, this.path = t, T(this, P, r), T(this, Se, {});
  }
  param(e) {
    return e ? N(this, K, Cr).call(this, e) : N(this, K, Dr).call(this);
  }
  query(e) {
...
}, "ar"), Se = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakSet(), Cr = /* @__PURE__ */ __name2(function(e) {
  const t = u(this, P)[0][this.routeIndex][1][e], r = N(this, K, wt).call(this, t);
  return r && /\%/.test(r) ? kt(r) : r;
}, "Cr"), Dr = /* @__PURE__ */ __name2(function() {
  const e = {}, t = Object.keys(u(this, P)[0][this.routeIndex][1]);
  for (const r of t) {
    const a = N(this, K, wt).call(this, u(this, P)[0][this.routeIndex][1][r]);
    a !== void 0 && (e[r] = /\%/.test(a) ? kt(a) : a);
  }
  return e;
}, "Dr"), wt = /* @__PURE__ */ __name2(function(e) {
...
var ye;
var sr;
var Aa = (sr = /* @__PURE__ */ __name2(class {
  constructor(e, t) {
    R(this, Q);
    R(this, Be);
    R(this, qe);
    ...
    R(this, $e);
    R(this, We);
    v(this, "render", (...e2) => (u(this, Oe) ?? T(this, Oe, (t2) => this.html(t2)), u(this, Oe).call(this, ...e2)));
    v(this, "setLayout", (e2) => T(this, Fe, e2));
    v(this, "getLayout", () => u(this, Fe));
    v(this, "setRenderer", (e2) => {
      T(this, Oe, e2);
    });
    v(this, "header", (e2, t2, r) => {
      this.finalized && T(this, H, new Response(u(this, H).body, u(this, H)));
      const a = u(this, H) ? u(this, H).headers : u(this, de) ?? T(this, de, new Headers());
    ...
    v(this, "get", (e2) => u(this, V) ? u(this, V).get(e2) : void 0);
    v(this, "newResponse", (...e2) => N(this, Q, ye).call(this, ...e2));
    v(this, "body", (e2, t2, r) => N(this, Q, ye).call(this, e2, t2, r));
    v(this, "text", (e2, t2, r) => !u(this, de) && !u(this, we) && !t2 && !r && !this.finalized ? new Response(e2) : N(this, Q, ye).call(this, e2, t2, mt(Da, r)));
    v(this, "json", (e2, t2, r) => N(this, Q, ye).call(this, JSON.stringify(e2), t2, mt("application/json", r)));
    v(this, "html", (e2, t2, r) => {
      const a = /* @__PURE__ */ __name2((s) => N(this, Q, ye).call(this, s, t2, mt("text/html; charset=UTF-8", r)), "a");
    ...
    v(this, "notFound", () => (u(this, Ne) ?? T(this, Ne, () => new Response()), u(this, Ne).call(this, this)));
    T(this, Be, e), t && (T(this, Y, t.executionCtx), this.env = t.env, T(this, Ne, t.notFoundHandler), T(this, We, t.path), T(this, $e, t.matchResult));
  }
  get req() {
    return u(this, qe) ?? T(this, qe, new br(u(this, Be), u(this, We), u(this, $e))), u(this, qe);
  }
  get event() {
  ...
  get res() {
    return u(this, H) || T(this, H, new Response(null, { headers: u(this, de) ?? T(this, de, new Headers()) }));
  }
  set res(e) {
    if (u(this, H) && e) {
    ...
    T(this, H, e), this.finalized = true;
  }
  get var() {
    return u(this, V) ? Object.fromEntries(u(this, V)) : {};
  }
}, "sr"), Be = /* @__PURE__ */ new WeakMap(), qe = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakMap(), we = /* @__PURE__ */ new WeakMap(), Y = /* @__PURE__ */ new WeakMap(), H = /* @__PURE__ */ new WeakMap(), Fe = /* @__PURE__ */ new WeakMap(), Oe = /* @__PURE__ */ new WeakMap(), Ne = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ new WeakMap(), $e = /* @__PURE__ */ new WeakMap(), We = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakSet(), ye = /* @__PURE__ */ __name2(function(e, t, r) {
  const a = u(this, H) ? new Headers(u(this, H).headers) : u(this, de) ?? new Headers();
...
var xa = /* @__PURE__ */ __name2((e) => e.text("404 Not Found", 404), "xa");
...
var Ir = (nr = /* @__PURE__ */ __name2(class {
  constructor(t = {}) {
    ...
    v(this, "routes", []);
    R(this, q, xa);
    v(this, "errorHandler", zt);
    v(this, "onError", (t2) => (this.errorHandler = t2, this));
    v(this, "notFound", (t2) => (T(this, q, t2), this));
    v(this, "fetch", (t2, ...r) => N(this, D, tt).call(this, t2, r[1], r[0], t2.method));
    v(this, "request", (t2, r, a2, s2) => t2 instanceof Request ? this.fetch(r ? new Request(t2, r) : t2, a2, s2) : (t2 = t2.toString(), this.fetch(new Request(/^https?:\/\//.test(t2) ? t2 : `http://localhost${Te("/", t2)}`, r), a2, s2)));
    v(this, "fire", () => {
    ...
    [...Ia, ja].forEach((n) => {
      ...
      for (const c of [o].flat()) {
        ...
        for (const l of [n].flat())
          i.map((d) => {
            N(this, D, ie).call(this, l.toUpperCase(), u(this, B), d);
          });
      }
      return this;
    ...
    const { strict: a, ...s } = t;
    Object.assign(this, s), this.getPath = a ?? true ? t.getPath ?? wr : Na;
  }
  route(t, r) {
    ...
    return r.routes.map((s) => {
      var o;
      let n;
      r.errorHandler === zt ? n = s.handler : (n = /* @__PURE__ */ __name2(async (i, c) => (await Wt([], r.errorHandler)(i, () => s.handler(i, c))).res, "n"), n[Ma] = s.handler), N(o = a, D, ie).call(o, s.method, s.path, n);
    }), this;
  }
  basePath(t) {
    const r = N(this, D, Mr).call(this);
...
}, "nr"), B = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakSet(), Mr = /* @__PURE__ */ __name2(function() {
...
}, "Mr"), q = /* @__PURE__ */ new WeakMap(), ie = /* @__PURE__ */ __name2(function(t, r, a) {
  ...
  const n = this.getPath(t, { env: a }), o = this.router.match(s, n), i = new Aa(t, { path: n, matchResult: o, env: a, executionCtx: r, notFoundHandler: u(this, q) });
  if (o[0].length === 1) {
    let l;
    try {
      l = o[0][0][0][0](i, async () => {
    ...
    return l instanceof Promise ? l.then((d) => d || (i.finalized ? i.res : u(this, q).call(this, i))).catch((d) => N(this, D, et).call(this, d, i)) : l ?? u(this, q).call(this, i);
  }
  const c = Wt(o[0], this.errorHandler, u(this, q));
  return (async () => {
    try {
      const l = await c(i);
      if (!l.finalized)
  ...
  insert(t, r, a, s, n) {
    ...
    if (c) {
      ...
      if (l = u(this, F)[p], !l) {
        ...
        if (n)
          return;
        l = u(this, F)[p] = new Ot(), d !== "" && T(l, fe, s.varIndex++);
      }
      !n && d !== "" && a.push([d, u(l, fe)]);
    } else if (l = u(this, F)[o], !l) {
      if (Object.keys(u(this, F)).some((d) => d.length > 1 && d !== xe && d !== Le))
        throw Re;
      if (n)
        return;
      l = u(this, F)[o] = new Ot();
...
var ke;
var ir;
var Pa = (ir = /* @__PURE__ */ __name2(class {
  constructor() {
...
function qa(e) {
  ...
  if (e.length === 0)
    return Ua;
  const a = e.map((d) => [!/\*|\/:/.test(d[0]), ...d]).sort(([d, p], [f, m]) => d ? 1 : f ? -1 : p.length - m.length), s = /* @__PURE__ */ Object.create(null);
  for (let d = 0, p = -1, f = a.length; d < f; d++) {
    const [m, _, h] = a[d];
    m ? s[_] = [h.map(([g]) => [g, /* @__PURE__ */ Object.create(null)]), xr] : p++;
    let E;
    try {
      E = t.insert(_, p, m);
    } catch (g) {
      throw g === Re ? new jr(_) : g;
    }
    m || (r[p] = h.map(([g, y]) => {
  ...
  for (let d = 0, p = r.length; d < p; d++)
    for (let f = 0, m = r[d].length; f < m; f++) {
      const _ = (l = r[d][f]) == null ? void 0 : l[1];
      if (!_)
        continue;
...
var J;
var lr;
var $a = (lr = /* @__PURE__ */ __name2(class {
  constructor(e) {
...
var Ur = (dr = /* @__PURE__ */ __name2(class {
  ...
  insert(e, t, r) {
    ...
    for (let o = 0, i = s.length; o < i; o++) {
      ...
      u(a, x)[p] = new Ur(), d && (u(a, pe).push(d), n.push(d[1])), a = u(a, x)[p];
    }
      ...
      for (let m = 0, _ = s.length; m < _; m++) {
        ...
        for (let g = 0, y = u(h, pe).length; g < y; g++) {
          ...
          if (!d && !(oe instanceof RegExp))
            continue;
          const k = u(h, x)[M], Kr = n.slice(c).join("/");
          if (oe instanceof RegExp) {
            const X = oe.exec(Kr);
            if (X) {
              if (w[_e] = X[0], r.push(...N(this, G, ce).call(this, k, e, u(h, j), w)), Object.keys(u(k, x)).length) {
                T(k, j, w);
          ...
          (oe === true || oe.test(d)) && (w[_e] = d, p ? (r.push(...N(this, G, ce).call(this, k, e, w, u(h, j))), u(k, x)["*"] && r.push(...N(this, G, ce).call(this, u(k, x)["*"], e, w, u(h, j)))) : (T(k, j, w), f.push(k)));
        }
      }
      s = f.concat(o.shift() ?? []);
    }
...
}, "dr"), ae = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakMap(), be = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakSet(), ce = /* @__PURE__ */ __name2(function(e, t, r, a) {
  const s = [];
  for (let n = 0, o = u(e, ae).length; n < o; n++) {
    ...
    if (c !== void 0 && (c.params = /* @__PURE__ */ Object.create(null), s.push(c), r !== Ie || a && a !== Ie))
      for (let d = 0, p = c.possibleKeys.length; d < p; d++) {
        const f = c.possibleKeys[d], m = l[c.score];
        c.params[f] = a != null && a[f] && !m ? a[f] : r[f] ?? (a == null ? void 0 : a[f]), l[c.score] = true;
      }
  }
  return s;
}, "ce"), dr);
var he;
var ur;
var Wa = (ur = /* @__PURE__ */ __name2(class {
  constructor() {
...
var me = /* @__PURE__ */ __name2(class extends Ir {
  constructor(e = {}) {
    super(e), this.router = e.router ?? new $a({ routers: [new Fa(), new Wa()] });
  }
}, "me");
...
var Vt = /* @__PURE__ */ __name2((e, t = Ya) => {
...
var Xa = /* @__PURE__ */ __name2((e) => {
  ...
  return async (s, n) => {
    ...
    if (l) {
      const _ = e.mimes && Vt(i, e.mimes) || Vt(i);
      if (s.header("Content-Type", _ || "application/octet-stream"), e.precompressed && (!_ || za.test(_))) {
        const h = new Set((p = s.req.header("Accept-Encoding")) == null ? void 0 : p.split(",").map((E) => E.trim()));
        for (const E of Ga) {
          if (!h.has(E))
            continue;
          const g = await c(i + Br[E], s);
          if (g) {
            l = g, s.header("Content-Encoding", E), s.header("Vary", "Accept-Encoding", { append: true });
            break;
          }
        }
      }
...
var Za = /* @__PURE__ */ __name2(async (e, t) => {
  let r;
...
var Qa = /* @__PURE__ */ __name2((e) => async function(r, a) {
...
var es = /* @__PURE__ */ __name2((e) => Qa(e), "es");
var Pe = "_hp";
...
var Wr = /* @__PURE__ */ __name2((e, t, r) => {
  ...
  for (let d = 0, p = a.length; d < p; d++, i++) {
    ...
    if (f.s && f.e)
      ...
      const _ = r || !f.e;
      z(f) ? (f.e && f.d && (f.e.textContent = f.t), f.d = false, m = f.e || (f.e = document.createTextNode(f.t))) : (m = f.e || (f.e = f.n ? document.createElementNS(f.n, f.tag) : document.createElement(f.tag)), ss(m, f.props, f.pP), Wr(f, m, _));
    }
    f.tag === Pe ? i-- : r ? m.parentNode || t.appendChild(m) : o[i] !== m && o[i - 1] !== m && (o[i + 1] === m ? t.appendChild(o[i]) : t.insertBefore(m, c || o[i] || null));
  }
  if (e.pP && delete e.pP, n.length) {
    const d = [], p = [];
    n.forEach(([, f, , m, _]) => {
      f && d.push(f), m && p.push(m), _ == null || _();
    }), d.forEach((f) => f()), p.length && requestAnimationFrame(() => {
      p.forEach((f) => f());
    });
  }
}, "Wr");
var is = /* @__PURE__ */ __name2((e, t) => !!(e && e.length === t.length && e.every((r, a) => r[1] === t[a][1])), "is");
...
var bt = /* @__PURE__ */ __name2((e, t, r) => {
  ...
  try {
    ...
    for (let _ = 0; _ < r.length; _++) {
      Array.isArray(r[_]) && r.splice(_, 1, ...r[_].flat());
      let h = cs(r[_]);
      if (h) {
        ...
        if (E)
          if (z(h))
            ...
            if (E.props = h.props, E.f || (E.f = h.f || t.f), typeof h.tag == "function") {
              const y = E[b][2];
              E[b][2] = h[b][2] || [], E[b][3] = h[b][3], !E.f && ((E.o || E) === h.o || (c = (i = E.tag)[ta]) != null && c.call(i, g, E.props)) && is(y, E[b][2]) && (E.s = true);
            }
            h = E;
          }
        else if (!z(h) && De) {
        ...
        if (!z(h) && !h.s && (bt(e, h), delete h.f), f.push(h), m && !m.s && !h.s)
          for (let g = m; g && !z(g); g = (l = g.vC) == null ? void 0 : l.at(-1))
            g.nN = h;
        m = h;
      }
    }
    ...
    const [f, m, _] = ((d = t[b]) == null ? void 0 : d[3]) || [];
    if (m) {
      const h = /* @__PURE__ */ __name2(() => st([0, false, e[2]], _), "h"), E = at.get(_) || [];
      E.push(h), at.set(_, E);
      const g = m(p, () => {
        const y = at.get(_);
        if (y) {
      ...
      if (g) {
        if (e[0] === 1)
          e[1] = true;
        else if (bt(e, _, [g]), (m.length === 1 || e !== f) && _.c) {
          $r(_, _.c, false);
          return;
        }
        throw Kt;
...
var ls = /* @__PURE__ */ __name2((e, t, r) => ({ tag: Pe, props: { children: e }, key: r, e: t, p: 1 }), "ls");
var _t = 0;
var kr = 1;
var gt = 2;
var vt = 3;
...
var ms = /* @__PURE__ */ __name2((e) => {
  er.add(e), e.finally(() => er.delete(e));
}, "ms");
var xt = /* @__PURE__ */ __name2((e, t) => ps(() => (r) => {
  let a;
...
var Je = /* @__PURE__ */ __name2((e, t, r, a, s) => {
  ...
  const h = Mt((y) => {
    if (m.length > 0) {
      ...
      O || n.insertBefore(y, n.contains(_[0]) ? _[0] : n.querySelector(e)), _ = void 0;
    }
  }, [c]), E = xt(t.ref, (y) => {
    var M;
    const O = m[0];
    if (r === 2 && (y.innerHTML = ""), (f || _) && h(y), !i && !o)
      return;
    let w = ve[M = y.getAttribute(O)] || (ve[M] = new Promise((_e, oe) => {
      y.addEventListener("load", _e), y.addEventListener("error", oe);
    }));
  ...
  if (s && l === "render") {
    const y = Xe[e][0];
    if (t[y]) {
      const O = t[y], w = ve[O] || (ve[O] = new Promise((M, _e) => {
        h(p), p.addEventListener("load", M), p.addEventListener("error", _e);
      }));
      fs(w);
    }
  }
  const g = { tag: e, type: e, props: { ...d, ref: E }, ref: E };
  return g.p = r, p && (g.e = p), ls(g, n);
}, "Je");
...
var _s = /* @__PURE__ */ __name2((e) => !e || ["src", "async"].some((t) => !e[t]) ? { tag: "script", props: e, type: "script", ref: e.ref } : Je("script", e, 1, false, true), "_s");
var gs = /* @__PURE__ */ __name2((e) => !e || !["href", "precedence"].every((t) => t in e) ? { tag: "style", props: e, type: "style", ref: e.ref } : (e["data-href"] = e.href, delete e.href, Je("style", e, 2, true, true)), "gs");
var vs = /* @__PURE__ */ __name2((e) => !e || ["onLoad", "onError"].some((t) => t in e) || e.rel === "stylesheet" && (!("precedence" in e) || "disabled" in e) ? { tag: "link", props: e, type: "link", ref: e.ref } : Je("link", e, 1, "precedence" in e, true), "vs");
var Ts = /* @__PURE__ */ __name2((e) => Je("meta", e, void 0, false, false), "Ts");
var Vr = Symbol();
var ys = /* @__PURE__ */ __name2((e) => {
  const { action: t, ...r } = e;
  typeof t != "function" && (r.action = t);
  const [a, s] = us([null, false]), n = Mt(async (l) => {
...
var Rs = /* @__PURE__ */ __name2((e) => Yr("input", e), "Rs");
var Ss = /* @__PURE__ */ __name2((e) => Yr("button", e), "Ss");
Object.assign(St, { title: Es, script: _s, style: gs, link: vs, meta: Ts, form: ys, input: Rs, button: Ss });
Dt(null);
new TextEncoder();
var ws = Dt(null);
var Os = /* @__PURE__ */ __name2((e, t, r, a) => (s, n) => {
  const o = "<!DOCTYPE html>", i = r ? Ft((l) => r(l, e), { Layout: t, ...n }, s) : s, c = ea`${U(o)}${Ft(ws.Provider, { value: e }, i)}`;
  return e.html(c);
}, "Os");
var Ns = /* @__PURE__ */ __name2((e, t) => function(a, s) {
  const n = a.getLayout() ?? ha;
  return e && a.setLayout((o) => e({ ...o, Layout: n }, a)), a.setRenderer(Os(a, n, e)), s();
}, "Ns");
var bs = Ns(({ children: e }) => S("html", { lang: "es", children: [S("head", { children: [S("meta", { charset: "UTF-8" }), S("meta", { name: "viewport", content: "width=device-width, initial-scale=1.0" }), S("title", { children: "Yo Decreto - Gustavo Adolfo Guerrero Casta\xF1os" }), S("link", { rel: "icon", href: "/static/logo-yo-decreto.png", type: "image/png" }), S("link", { href: "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap", rel: "stylesheet" }), S("script", { src: "https://cdn.tailwindcss.com" }), S("link", { href: "https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css", rel: "stylesheet" }), S("script", { src: "https://cdn.jsdelivr.net/npm/chart.js" }), S("script", { src: "https://cdn.jsdelivr.net/npm/dayjs@1.11.10/dayjs.min.js" }), S("script", { src: "https://cdn.jsdelivr.net/npm/dayjs@1.11.10/plugin/customParseFormat.js" }), S("script", { src: "https://cdn.jsdelivr.net/npm/dayjs@1.11.10/plugin/isSameOrAfter.js" }), S("script", { src: "https://cdn.jsdelivr.net/npm/dayjs@1.11.10/plugin/isSameOrBefore.js" }), S("script", { src: "https://cdn.jsdelivr.net/npm/axios@1.6.0/dist/axios.min.js" }), S("link", { href: `/static/styles.css?v=${Date.now()}&cb=${Math.random()}&t=${(/* @__PURE__ */ new Date()).getTime()}`, rel: "stylesheet" }), S("script", { dangerouslySetInnerHTML: { __html: `
            tailwind.config = {
              theme: {
                extend: {
                  fontFamily: {
...
async function Cs(e, t, r, a, s, n, o) {
  try {
...
I.post("/:id/acciones", async (e) => {
  ...
  try {
    ...
    `).bind(m, r, s, n, o || "", i || "", JSON.stringify(c || []), l || "secundaria", d || null, p || null).run(), console.log("\u2705 Acci\xF3n creada:", m), d) {
      console.log("\u{1F525} FORZANDO creaci\xF3n en agenda para:", { accionId: m, titulo: s, proxima_revision: d });
      const h = d.split("T")[0], E = d.split("T")[1] || "09:00";
      try {
        ...
        `).bind(m, `[Decreto] ${s}`, `${n}${o ? " - " + o : ""}`, h, E, "media").run();
    ...
    if (console.log("=== PROCESANDO SUB-TAREAS ===", { hasSubtareas: !!f, subtareasLength: (f == null ? void 0 : f.length) || 0, subtareasData: f }), f && f.length > 0) {
      ...
      for (let h = 0; h < f.length; h++) {
        ...
        if (console.log(`Sub-tarea ${h + 1}:`, E), E.titulo) {
          ...
          !y && d && (y = d), console.log(`Creando sub-tarea ${h + 1} con ID: ${g}`, { titulo: E.titulo, queHacer: E.que_hacer, fecha: y, padreId: m });
          const O = await e.env.DB.prepare(`
            INSERT INTO acciones (
              id, decreto_id, titulo, que_hacer, como_hacerlo, resultados, 
              tipo, proxima_revision, origen, tarea_padre_id, nivel_jerarquia
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(g, r, E.titulo, E.que_hacer, E.como_hacerlo || "", "", "secundaria", y, "subtarea", m, 1).run();
          console.log(`\u2705 Sub-tarea ${h + 1} creada en BD:`, { success: O.success, changes: O.changes }), y && (await Cs(e.env.DB, g, `[Sub] ${E.titulo}`, E.que_hacer, E.como_hacerlo, "secundaria", y), console.log(`\u2705 Sub-tarea ${h + 1} sincronizada con agenda`)), _++;
        } else
          console.log(`\u23ED\uFE0F Sub-tarea ${h + 1} sin t\xEDtulo, saltando`);
      }
    } else
      console.log("No hay sub-tareas para procesar");
    return console.log(`=== SUB-TAREAS COMPLETADAS: ${_} ===`), console.log("=== RESPUESTA FINAL ===", { success: true, accionId: m, subtareasCreadas: _ }), e.json({ success: true, id: m, data: { subtareas_creadas: _ } });
  } catch (r) {
    ...
    if (n && Array.isArray(n)) {
      for (const l of n)
        if (typeof l == "string" && l.trim()) {
          ...
          m && (f = m[1] + "T09:00", d = d.replace(/@\d{4}-\d{2}-\d{2}/g, "").trim());
          const _ = await e.env.DB.prepare("SELECT decreto_id FROM acciones WHERE id = ?").bind(t).first();
          if (_) {
            ...
            `).bind(_.decreto_id, d, "Tarea generada desde seguimiento", `Completar: ${d}`, p, f, `seguimiento:${t}`).run();
            let E = null;
            if (p === "secundaria") {
              ...
              p === "primaria" && f && (E = (await e.env.DB.prepare(`
                INSERT INTO agenda_eventos (accion_id, titulo, descripcion, fecha_evento, hora_evento, prioridad)
                VALUES (?, ?, ?, date(?), time(?), ?)
              `).bind(h.meta.last_row_id, `[Semanal] ${d}`, "Tarea generada desde seguimiento", f.split("T")[0], f.split("T")[1], "media").run()).meta.last_row_id);
            E && await e.env.DB.prepare(`
...
L.put("/tareas/:id", async (e) => {
  try {
    ...
    const m = await e.env.DB.prepare("SELECT accion_id FROM agenda_eventos WHERE id = ?").bind(t).first();
    return m != null && m.accion_id && await e.env.DB.prepare(`
        UPDATE acciones SET 
          titulo = ?,
          que_hacer = ?,
          como_hacerlo = ?,
          ...
          updated_at = CURRENT_TIMESTAMP
        WHERE id = ?
      `).bind(r, n || "", o || "", i || "", c || "secundaria", s, l || null, m.accion_id).run(), e.json({ success: true });
  } catch {
...
var Is = /* @__PURE__ */ __name2((e, t) => {
  ...
  for (let s of r) {
    ...
    if (i.startsWith('"') && i.endsWith('"') && (i = i.slice(1, -1)), js.test(i)) {
...
var yt = /* @__PURE__ */ __name2((e, t, r) => (t = encodeURIComponent(t), Ms(e, t, r)), "yt");
...
var Jr = /* @__PURE__ */ __name2((e, t, r, a) => {
  const s = xs(t, r, a);
...
W.use("/static/*", es());
W.route("/api/auth", Ee);
W.route("/api/decretos", I);
W.route("/api/agenda", L);
W.route("/api/progreso", ne);
W.route("/api/practica", A);
W.get("/", (e) => e.render(S("div", { children: S("div", { id: "app", children: S("div", { className: "loading-screen", children: [S("img", { src: "/static/logo-yo-decreto.png", alt: "Yo Decreto", className: "logo-yo-decreto logo-lg w-auto mx-auto mb-4" }), S("div", { className: "loader" }), S("h2", { children: "Cargando..." })] }) }) })));
W.get("*", (e) => e.render(S("div", { children: S("div", { id: "app", children: S("div", { className: "loading-screen", children: [S("img", { src: "/static/logo-yo-decreto.png", alt: "Yo Decreto", className: "logo-yo-decreto logo-lg w-auto mx-auto mb-4" }), S("div", { className: "loader" }), S("h2", { children: "Cargando..." })] }) }) })));
var rr = new me();
var Ls = Object.assign({ "/src/index.tsx": W });
var Gr = false;
for (const [, e] of Object.entries(Ls))
...
// .wrangler/tmp/pages-QwK9mR/o80fcc1d97s.js
...
// .wrangler/tmp/bundle-LCUy48/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-LCUy48/middleware-loader.entry.ts
