...
// .wrangler/tmp/bundle-uTGvAx/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-ZWkDs3/bundledWorker-0.09197638648137585.mjs
...
var Bt = /* @__PURE__ */ __name2((e) => (e[Er] = true, e), "Bt");
...
var Ve = /* @__PURE__ */ __name2((e, t, r) => B(new F(e, r, ze(t ?? [])).toString()), "Ve");
...
var F = /* @__PURE__ */ __name2(class {
  ...
  toStringToBuffer(e) {
    ...
    let { children: a } = this;
    e[0] += `<${t}`;
    const s = Pe && Ae(Pe) === "svg" ? (n) => ua(ot(n)) : (n) => ot(n);
...
var Qe = /* @__PURE__ */ __name2((e, t, r) => {
  ...
  return typeof e == "function" ? new pt(e, t, r) : ft[e] ? new pt(ft[e], t, r) : e === "svg" || e === "head" ? (Pe || (Pe = Dt("")), new F(e, t, [new pt(Pe, { value: e }, r)])) : new F(e, t, r);
}, "Qe");
...
var Nr = (ar = /* @__PURE__ */ __name2(class {
  constructor(e, t = "/", r = [[]]) {
    ...
    this.raw = e, this.path = t, y(this, H, r), y(this, Se, {});
  }
  param(e) {
...
}, "ar"), Se = /* @__PURE__ */ new WeakMap(), H = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakSet(), Cr = /* @__PURE__ */ __name2(function(e) {
  const t = u(this, H)[0][this.routeIndex][1][e], r = O(this, K, wt).call(this, t);
  return r && /\%/.test(r) ? Wt(r) : r;
}, "Cr"), Dr = /* @__PURE__ */ __name2(function() {
  const e = {}, t = Object.keys(u(this, H)[0][this.routeIndex][1]);
  for (const r of t) {
    const a = O(this, K, wt).call(this, u(this, H)[0][this.routeIndex][1][r]);
...
var ja = (sr = /* @__PURE__ */ __name2(class {
  constructor(e, t) {
    ...
    R(this, Fe);
    R(this, $e);
    g(this, "render", (...e2) => (u(this, be) ?? y(this, be, (t2) => this.html(t2)), u(this, be).call(this, ...e2)));
    g(this, "setLayout", (e2) => y(this, ke, e2));
    g(this, "getLayout", () => u(this, ke));
    ...
    g(this, "text", (e2, t2, r) => !u(this, de) && !u(this, we) && !t2 && !r && !this.finalized ? new Response(e2) : O(this, Q, Te).call(this, e2, t2, mt(Da, r)));
    ...
    g(this, "notFound", () => (u(this, Oe) ?? y(this, Oe, () => new Response()), u(this, Oe).call(this, this)));
    y(this, Ue, e), t && (y(this, J, t.executionCtx), this.env = t.env, y(this, Oe, t.notFoundHandler), y(this, $e, t.path), y(this, Fe, t.matchResult));
  }
  get req() {
    return u(this, qe) ?? y(this, qe, new Nr(u(this, Ue), u(this, $e), u(this, Fe))), u(this, qe);
  }
  get event() {
    if (u(this, J) && "respondWith" in u(this, J))
      return u(this, J);
...
var Ir = (nr = /* @__PURE__ */ __name2(class {
  constructor(t = {}) {
    ...
    [...Ia, Aa].forEach((n) => {
      this[n] = (o, ...i) => (typeof o == "string" ? y(this, U, o) : O(this, D, ie).call(this, n, u(this, U), o), i.forEach((c) => {
        O(this, D, ie).call(this, n, u(this, U), c);
      }), this);
    }), this.on = (n, o, ...i) => {
      for (const c of [o].flat()) {
        ...
        for (const d of [n].flat())
          i.map((l) => {
            O(this, D, ie).call(this, d.toUpperCase(), u(this, U), l);
          });
      }
      return this;
    }, this.use = (n, ...o) => (typeof n == "string" ? y(this, U, n) : (y(this, U, "*"), o.unshift(n)), o.forEach((i) => {
      O(this, D, ie).call(this, C, u(this, U), i);
    }), this);
    const { strict: a, ...s } = t;
  ...
  mount(t, r, a) {
    ...
    s || (s = (() => {
      const c = ye(this._basePath, t), d = c === "/" ? 0 : c.length;
      return (l) => {
...
}, "nr"), U = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakSet(), xr = /* @__PURE__ */ __name2(function() {
  ...
  if (o[0].length === 1) {
    ...
    return d instanceof Promise ? d.then((l) => l || (i.finalized ? i.res : u(this, q).call(this, i))).catch((l) => O(this, D, et).call(this, l, i)) : d ?? u(this, q).call(this, i);
  }
...
var bt = (or = /* @__PURE__ */ __name2(class {
  ...
  insert(t, r, a, s, n) {
    ...
    if (c) {
      ...
      if (l && c[2] && (p === ".*" || (p = p.replace(/^\((?!\?:)(?=[^)]+\)$)/, "(?:"), /\((?!\?:)/.test(p))))
        throw Re;
      if (d = u(this, k)[p], !d) {
        if (Object.keys(u(this, k)).some((f) => f !== Me && f !== Le))
          throw Re;
        if (n)
          return;
        d = u(this, k)[p] = new bt(), l !== "" && y(d, fe, s.varIndex++);
      }
      !n && l !== "" && a.push([l, u(d, fe)]);
    } else if (d = u(this, k)[o], !d) {
      if (Object.keys(u(this, k)).some((l) => l.length > 1 && l !== Me && l !== Le))
        throw Re;
      if (n)
        return;
      d = u(this, k)[o] = new bt();
  ...
  buildRegExpStr() {
    const r = Object.keys(u(this, k)).sort(Pa).map((a) => {
      const s = u(this, k)[a];
...
var We;
var ir;
var Ha = (ir = /* @__PURE__ */ __name2(class {
  constructor() {
...
function qa(e) {
  ...
  if (e.length === 0)
    return Ba;
  const a = e.map((l) => [!/\*|\/:/.test(l[0]), ...l]).sort(([l, p], [f, E]) => l ? 1 : f ? -1 : p.length - E.length), s = /* @__PURE__ */ Object.create(null);
  ...
  for (let l = 0, p = r.length; l < p; l++)
    for (let f = 0, E = r[l].length; f < E; f++) {
...
var ka = (cr = /* @__PURE__ */ __name2(class {
  ...
  match(e, t) {
    Ua();
    const r = O(this, je, Pr).call(this);
...
}, "cr"), ee = /* @__PURE__ */ new WeakMap(), te = /* @__PURE__ */ new WeakMap(), je = /* @__PURE__ */ new WeakSet(), Pr = /* @__PURE__ */ __name2(function() {
  const e = /* @__PURE__ */ Object.create(null);
  return Object.keys(u(this, te)).concat(Object.keys(u(this, ee))).forEach((t) => {
    e[t] || (e[t] = O(this, je, Hr).call(this, t));
  }), y(this, ee, y(this, te, void 0)), e;
}, "Pr"), Hr = /* @__PURE__ */ __name2(function(e) {
  const t = [];
  let r = e === C;
...
var Fa = (lr = /* @__PURE__ */ __name2(class {
  ...
  match(e, t) {
    ...
    const r = u(this, re), a = u(this, Y), s = r.length;
    let n = 0, o;
    for (; n < s; n++) {
      const i = r[n];
      try {
  ...
  get activeRouter() {
    if (u(this, Y) || u(this, re).length !== 1)
...
var ce;
var dr;
var Br = (dr = /* @__PURE__ */ __name2(class {
  constructor(e, t, r) {
    R(this, G);
    R(this, ae);
    R(this, x);
  ...
  insert(e, t, r) {
    y(this, Ne, ++Ht(this, Ne)._);
    let a = this;
    const s = Ta(t), n = [];
    for (let o = 0, i = s.length; o < i; o++) {
      const c = s[o], d = s[o + 1], l = wa(c, d), p = Array.isArray(l) ? l[0] : c;
      if (p in u(a, x)) {
        a = u(a, x)[p], l && n.push(l[1]);
        continue;
      }
      u(a, x)[p] = new Br(), l && (u(a, pe).push(l), n.push(l[1])), a = u(a, x)[p];
    }
  ...
  search(e, t) {
    ...
    for (let c = 0, d = n.length; c < d; c++) {
      ...
      for (let E = 0, v = s.length; E < v; E++) {
        const h = s[E], m = u(h, x)[l];
        m && (y(m, j, u(h, j)), p ? (u(m, x)["*"] && r.push(...O(this, G, ce).call(this, u(m, x)["*"], e, u(h, j))), r.push(...O(this, G, ce).call(this, m, e, u(h, j)))) : f.push(m));
        for (let _ = 0, T = u(h, pe).length; _ < T; _++) {
          const b = u(h, pe)[_], w = u(h, j) === Ie ? {} : { ...u(h, j) };
          if (b === "*") {
            const X = u(h, x)["*"];
            X && (r.push(...O(this, G, ce).call(this, X, e, u(h, j))), y(X, j, w), f.push(X));
            continue;
          }
          const [I, ve, oe] = b;
          if (!l && !(oe instanceof RegExp))
            continue;
          const W = u(h, x)[I], Kr = n.slice(c).join("/");
          if (oe instanceof RegExp) {
            const X = oe.exec(Kr);
            if (X) {
              if (w[ve] = X[0], r.push(...O(this, G, ce).call(this, W, e, u(h, j), w)), Object.keys(u(W, x)).length) {
                y(W, j, w);
          ...
          (oe === true || oe.test(l)) && (w[ve] = l, p ? (r.push(...O(this, G, ce).call(this, W, e, w, u(h, j))), u(W, x)["*"] && r.push(...O(this, G, ce).call(this, u(W, x)["*"], e, w, u(h, j)))) : (y(W, j, w), f.push(W)));
        }
      }
      s = f.concat(o.shift() ?? []);
    }
  ...
  for (let n = 0, o = u(e, ae).length; n < o; n++) {
    ...
    if (c !== void 0 && (c.params = /* @__PURE__ */ Object.create(null), s.push(c), r !== Ie || a && a !== Ie))
      for (let l = 0, p = c.possibleKeys.length; l < p; l++) {
        const f = c.possibleKeys[l], E = d[c.score];
        c.params[f] = a != null && a[f] && !E ? a[f] : r[f] ?? (a == null ? void 0 : a[f]), d[c.score] = true;
      }
  }
  return s;
}, "ce"), dr);
    ...
    if (d) {
      ...
      if (s.header("Content-Type", v || "application/octet-stream"), e.precompressed && (!v || za.test(v))) {
        ...
        for (const m of Ga) {
          ...
          if (_) {
            d = _, s.header("Content-Encoding", m), s.header("Vary", "Accept-Encoding", { append: true });
            break;
          }
        }
      }
...
var $r = /* @__PURE__ */ __name2((e, t, r) => {
  ...
  for (let l = 0, p = a.length; l < p; l++, i++) {
    ...
    f.tag === He ? i-- : r ? E.parentNode || t.appendChild(E) : o[i] !== E && o[i - 1] !== E && (o[i + 1] === E ? t.appendChild(o[i]) : t.insertBefore(E, c || o[i] || null));
  }
  if (e.pP && delete e.pP, n.length) {
    const l = [], p = [];
    n.forEach(([, f, , E, v]) => {
      f && l.push(f), E && p.push(E), v == null || v();
...
var Nt = /* @__PURE__ */ __name2((e, t, r) => {
  ...
  try {
    ...
    for (let v = 0; v < r.length; v++) {
      ...
      if (h) {
        ...
        if (!z(h) && !h.s && (Nt(e, h), delete h.f), f.push(h), E && !E.s && !h.s)
          for (let _ = E; _ && !z(_); _ = (d = _.vC) == null ? void 0 : d.at(-1))
            _.nN = h;
        E = h;
      }
    }
    ...
    const [f, E, v] = ((l = t[N]) == null ? void 0 : l[3]) || [];
    if (E) {
...
var ls = /* @__PURE__ */ __name2((e, t, r) => ({ tag: He, props: { children: e }, key: r, e: t, p: 1 }), "ls");
var vt = 0;
var Wr = 1;
var gt = 2;
var _t = 3;
...
var us = /* @__PURE__ */ __name2((e) => {
  var o;
  const t = /* @__PURE__ */ __name2(() => typeof e == "function" ? e() : e, "t"), r = Be.at(-1);
  if (!r)
    return [t(), () => {
    }];
...
var Ye = /* @__PURE__ */ __name2((e, t, r, a, s) => {
  ...
  const _ = { tag: e, type: e, props: { ...l, ref: m }, ref: m };
...
var Ts = /* @__PURE__ */ __name2((e) => {
  ...
  const [a, s] = us([null, false]), n = xt(async (d) => {
    const l = d.isTrusted ? t : d.detail[Vr];
  ...
  }, []), o = Mt(e.ref, (d) => (d.addEventListener("submit", n), () => {
...
var bs = /* @__PURE__ */ __name2((e, t, r, a) => (s, n) => {
  const o = "<!DOCTYPE html>", i = r ? kt((d) => r(d, e), { Layout: t, ...n }, s) : s, c = ea`${B(o)}${kt(ws.Provider, { value: e }, i)}`;
  return e.html(c);
}, "bs");
...
A.post("/:id/acciones", async (e) => {
  ...
  try {
    ...
    `).bind(E, r, s, n, o || "", i || "", JSON.stringify(c || []), d || "secundaria", l || null, p || null).run(), await tr(e.env.DB, E, s, n, o, d, l);
    let v = 0;
    if (console.log("=== PROCESANDO SUB-TAREAS ===", { hasSubtareas: !!f, subtareasLength: (f == null ? void 0 : f.length) || 0, subtareasData: f }), f && f.length > 0) {
      ...
      for (let h = 0; h < f.length; h++) {
        ...
        if (console.log(`Sub-tarea ${h + 1}:`, m), m.titulo) {
          ...
          !T && l && (T = l), console.log(`Creando sub-tarea ${h + 1} con ID: ${_}`, { titulo: m.titulo, queHacer: m.que_hacer, fecha: T, padreId: E });
    ...
    if (n && Array.isArray(n)) {
      for (const d of n)
        if (typeof d == "string" && d.trim()) {
          ...
          const E = l.match(/@(\d{4}-\d{2}-\d{2})/);
          E && (f = E[1] + "T09:00", l = l.replace(/@\d{4}-\d{2}-\d{2}/g, "").trim());
          ...
          if (v) {
            ...
            if (p === "secundaria") {
              ...
              m = (await e.env.DB.prepare(`
                ...
                VALUES (?, ?, ?, ?, ?)
              `).bind(h.meta.last_row_id, l, `[Auto-generada] ${l}`, _, T).run()).meta.last_row_id;
            } else
...
// .wrangler/tmp/pages-ZWkDs3/3kuam9qgilo.js
...
// .wrangler/tmp/bundle-uTGvAx/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-uTGvAx/middleware-loader.entry.ts
...
//# sourceMappingURL=3kuam9qgilo.js.map
